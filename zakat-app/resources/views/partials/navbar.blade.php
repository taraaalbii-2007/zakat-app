        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button onclick="toggleSidebar()" 
                        class="lg:hidden p-2 rounded-lg text-neutral-600 hover:bg-neutral-100 hover:text-primary-600 transition-colors">
                ...
                <div class="hidden md:block relative">
                    <div class="relative">
                        <input type="text" 
                               placeholder="Cari zakat, laporan, dll..." 
                               class="pl-10 pr-4 py-2 w-64 lg:w-80 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden lg:flex items-center space-x-2">
                    <a href="" 
                       class="inline-flex items-center px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg shadow-nz transition-colors">
