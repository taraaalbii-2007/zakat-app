<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-gradient-primary text-white transform -translate-x-full lg:translate-x-0 transition-transform duration-300 shadow-nz-xl flex flex-col">
    ...
    <nav class="flex-1 p-4 overflow-y-auto">
        <ul class="space-y-1">
            ...
            <!-- Dashboard -->
            <li>
                <a href="{{ $isSuperadmin ? route('superadmin.dashboard') : ($isAdminMasjid ? route('admin.dashboard') : ($isAmil ? route('amil.dashboard') : '#')) }}"
            ...
            @if($isSuperadmin)
                ...
                <li>
                    <a href="{{ route('superadmin.masjid.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'superadmin.masjid') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('superadmin.user.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'superadmin.user') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($isAdminMasjid)
                ...
                <li>
                    <a href="{{ route('admin.konfigurasi.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'admin.konfigurasi') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                ...
                <li>
                    <a href="{{ route('admin.amil.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'admin.amil') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($isAmil || $isAdminMasjid)
                <li class="mt-4">
                    <p class="px-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Zakat</p>
                </li>
                <li>
                    <a href="{{ route('zakat.transaksi.create') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'zakat.transaksi.create') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('zakat.transaksi.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'zakat.transaksi.index') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('zakat.muzaki.index') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'zakat.muzaki') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                ...
                <li>
                    <a href="{{ route('laporan.harian') }}"
                       class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/10 transition-colors {{ str_contains($currentRoute, 'laporan') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
