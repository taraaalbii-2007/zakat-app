...
<div class="lg:col-span-2 order-1 lg:order-2">
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8 h-full flex flex-col gap-5">
        ...
        <div class="space-y-4">
            ...
            @if ($config->email_admin)
                <div class="flex items-center gap-3.5">
                    <svg class="flex-shrink-0 text-primary" style="width:18px;height:18px;color:#16a34a;" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0.5">Email</p>
                        <a href="mailto:{{ $config->email_admin }}" class="text-sm text-gray-800 hover:text-primary transition-colors break-all">
                            {{ $config->email_admin }}
                        </a>
                    </div>
                </div>
            ...
            @if ($config->whatsapp_support)
                <div class="flex items-center gap-3.5">
                    <svg class="flex-shrink-0" style="width:18px;height:18px;color:#16a34a;" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0.5">WhatsApp</p>
                        <a href="{{ $config->whatsapp_link }}" target="_blank" rel="noopener" class="text-sm text-gray-800 hover:text-primary transition-colors">
            ...
            @if ($config->telepon_admin)
                <div class="flex items-center gap-3.5">
                    <svg class="flex-shrink-0" style="width:18px;height:18px;color:#16a34a;" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0.5">Telepon</p>
                        <a href="tel:{{ $config->telepon_admin }}" class="text-sm text-gray-800 hover:text-primary transition-colors">
            ...
            @if ($config->alamat_kantor)
                <div class="flex items-start gap-3.5">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0.5">Alamat</p>
                        <p class="text-sm text-gray-800 leading-relaxed">{{ $config->alamat_kantor }}</p>
                    </div>
                </div>
            @endif
        ...
        {{-- Peta Alamat --}}
        @if ($config->alamat_kantor)
            <div class="rounded-xl overflow-hidden flex-shrink-0" style="height: 180px;">
                <iframe
                    src="https://maps.google.com/maps?q={{ urlencode($config->alamat_kantor) }}&output=embed&z=16"
                    width="100%"
                    height="100%"
        ...
        @if ($config->instagram_url || $config->facebook_url || $config->twitter_url || $config->youtube_url)
            <div class="pt-1 border-t border-gray-100">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Media Sosial</p>
