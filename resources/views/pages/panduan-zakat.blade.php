...
@section('content')
    ...
    <style>
        ...
        @keyframes glowPulse {
            ...
            50% {
                box-shadow: 0 0 16px 2px rgba(22, 163, 74, 0.12);
            }
        }
        ...
        .anim-fadedown {
            animation: fadeDown 0.55s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        ...
        .anim-scalepop {
            animation: scalePop 0.55s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
        ...
        .anim-floatin {
            animation: floatIn 0.75s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-rowslide {
            animation: rowSlide 0.45s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        /* Per-section specifics */
        .anim-flipinbl {
            animation: flipInBL 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-zoomfade {
            animation: zoomFade 0.65s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-slideblur {
            animation: slideBlurRight 0.65s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-cascade {
            animation: cascadeDrop 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-earthrise {
            animation: earthRise 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-sweepleft {
            animation: sweepLeft 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-springpop {
            animation: springPop 0.65s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }

        .anim-diagonal {
            animation: diagonalReveal 0.55s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-softdrift {
            animation: softDrift 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-spreadin {
            animation: spreadIn 0.65s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }

        .anim-wavein {
            animation: waveIn 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        .anim-badgeburst {
            animation: badgeBurst 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
        ...
        .formula-box.formula-revealed::before {
            transform: scaleY(1);
        }
        ...
        .ketentuan-table tr:last-child td {
            border-bottom: none;
        }

        .ketentuan-table tbody tr {
            opacity: 0;
        }
        ...
        .ketentuan-table tbody tr.row-visible td {
            opacity: 1;
        }

        .ketentuan-table tbody tr:hover td {
            background: #f9fffe;
        }
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <aside class="lg:w-60 flex-shrink-0">
                <div class="sidebar-card sticky top-24">
                    ...
                    <div
                        class="mx-3 mb-3 p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-100">
                        <p class="text-xs text-green-800 font-semibold mb-1">Siap menunaikan zakat?</p>
                        <p class="text-xs text-green-600 mb-3 leading-relaxed">Hitung kewajiban Anda sekarang dengan
                            kalkulator otomatis kami.</p>
            ...
            <main class="flex-1 min-w-0 space-y-10">
                ...
                <section id="jenis-zakat" class="scroll-mt-28 panduan-section" data-section-anim="flipinbl">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        @foreach ($daftarJenis as $i => $jenis)
                            <a href="{{ $jenis['anchor'] }}" class="info-card group flex gap-4 items-start anim-ready"
                                data-delay="{{ $i * 70 }}">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between mb-1.5">
                                        <h4 class="font-bold text-gray-900 text-sm">{{ $jenis['nama'] }}</h4>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-4 h-4 text-gray-300 group-hover:text-green-500 transition-colors flex-shrink-0 ml-2"
                ...
                <section id="zakat-fitrah" class="scroll-mt-28 panduan-section" data-section-anim="zoomfade">
                    ...
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        Wajib ditunaikan sebelum shalat Idul Fitri oleh setiap Muslim yang mampu. Dapat dibayar untuk diri
                        sendiri
                        maupun anggota keluarga yang menjadi tanggungan. Sistem menggunakan konstanta
                        <strong class="text-green-700">Rp 50.000/jiwa</strong> dan <strong class="text-green-700">2,5
                            kg/jiwa</strong> sesuai ketetapan BAZNAS 2024.
                    </p>
                        ...
                        @php
                            $ketentuanFitrah = [
                                ...
                                [
                                    'label' => 'Batas Waktu',
                                    'nilai' => 'Sebelum Id',
                                    'sub' => 'sebelum shalat Idul Fitri',
                                ],
                            ];
                        @endphp
                        @foreach ($ketentuanFitrah as $i => $k)
                            <div class="stat-tile anim-ready" data-delay="{{ 200 + $i * 100 }}">
                                <p class="text-xs text-green-600 uppercase tracking-wider font-semibold mb-2">
                                    {{ $k['label'] }}</p>
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: 4 jiwa &times; 2,5 kg = 10 kg
                            beras</span><br>
                        Total Uang = Total Fisik &times; Harga Beras/kg
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: 10 kg &times; Rp 14.000 = Rp
                            140.000</span>
                    </div>
                    <div class="note-box anim-ready" data-delay="600">
                        ...
                        <strong>infaq sukarela</strong> oleh sistem. Membayar lebih awal lebih afdhal agar amil dapat
                        menyalurkan tepat waktu.
                    </div>
                </section>
                ...
                <section id="zakat-mal" class="scroll-mt-28 panduan-section" data-section-anim="slideblur">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">Nisab 85 gr Emas &bull; Haul 1 Tahun &bull;
                        Kadar 2,5%</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        ...
                        @php
                            $ketentuanMal = [
                                [
                                    'label' => 'Nisab',
                                    'nilai' => '85 gram emas',
                                    'sub' => 'mengikuti harga emas terkini',
                                ],
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        Harta Bersih = Total Aset (Emas + Perak + Tabungan + Investasi + Properti) &minus; Hutang Jangka
                        Pendek<br>
                        Zakat = Harta Bersih &times; 2,5%
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: Rp 200.000.000 &times; 2,5% = Rp
                            5.000.000</span>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 anim-ready"
                        data-delay="600">
                        <table class="ketentuan-table">
                            <thead>
                                <tr>
                                    <th>Komponen Harta</th>
                                    <th>Keterangan</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="font-medium text-gray-800">Emas &amp; Perhiasan</td>
                                    <td class="text-gray-500">Dihitung gram &times; harga emas BAZNAS. Perhiasan yang
                                        dipakai sehari-hari ada perbedaan pendapat ulama.</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Perak</td>
                                    <td class="text-gray-500">Dihitung gram &times; harga perak. Nisab perak 595 gram.</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Tabungan / Deposito</td>
                                    <td class="text-gray-500">Saldo rekening bank, termasuk bunga/bagi hasil yang diterima.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Investasi / Saham</td>
                                    <td class="text-gray-500">Reksa dana, saham, obligasi, piutang yang kemungkinan besar
                                        tertagih.</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Properti Investasi</td>
                                    <td class="text-gray-500">Properti yang diniatkan untuk dijual atau disewakan. Properti
                                        hunian sendiri tidak wajib zakat.</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Hutang Jangka Pendek</td>
                                    <td class="text-gray-500">Dikurangkan dari total aset. Hanya hutang yang jatuh tempo
                                        dalam 1 tahun.</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="note-box anim-ready" data-delay="700">
                        Nisab perak (595 gram) umumnya lebih rendah nilainya dibanding emas. Jika harta tidak mencapai nisab
                        emas
                        namun mencapai nisab perak, sebagian ulama mewajibkan zakat. Konsultasikan dengan amil atau ulama
                        setempat.
                    </div>
                </section>
                ...
                <section id="zakat-profesi" class="scroll-mt-28 panduan-section" data-section-anim="cascade">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">Nisab 85 gr Emas/Tahun &bull; Tanpa Haul
                        &bull; Kadar 2,5%</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: Rp 10.000.000 &times; 2,5% = Rp
                            250.000/bulan</span>
                    </div>
                    <div class="info-card mb-4 anim-ready" data-delay="600">
                        ...
                        <div class="space-y-1 text-sm">
                            ...
                            @endforeach
                            <div
                                class="flex justify-between items-center py-3 mt-1 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl px-4">
                ...
                <section id="zakat-pertanian" class="scroll-mt-28 panduan-section" data-section-anim="earthrise">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">Nisab 652,8 kg &bull; Tanpa Haul &bull;
                        Kadar 5% atau 10%</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        Wajib atas hasil panen berupa padi, jagung, gandum, dan sejenisnya yang dapat dimakan dan disimpan.
                        Kadar zakat berbeda tergantung sumber pengairan. Tidak disyaratkan haul — dikeluarkan langsung saat
                        panen.
                    </p>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        @php
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-2">| Contoh: Rp 10.000.000 &times; 10% = Rp
                            1.000.000</span>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 anim-ready"
                        data-delay="600">
                        <table class="ketentuan-table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-medium text-gray-800">Air Hujan / Sungai / Mata Air Alami</td>
                                    <td><span class="font-bold text-green-700">10%</span></td>
                                    <td class="text-gray-500">Sawah tadah hujan, pengairan alami dari sungai tanpa biaya
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Irigasi / Pompa Air / Berbayar</td>
                                    <td><span class="font-bold text-green-700">5%</span></td>
                                    <td class="text-gray-500">Sawah dengan irigasi teknis, pompa listrik, atau biaya
                                        pengairan</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Campuran (sebagian alami, sebagian irigasi)</td>
                                    <td><span class="font-bold text-green-700">7,5%</span></td>
                                    <td class="text-gray-500">Kombinasi keduanya, kadar diambil rata-rata</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section id="zakat-ternak" class="scroll-mt-28 panduan-section" data-section-anim="sweepleft">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">Nisab Berbeda Per Jenis &bull; Haul 1 Tahun
                        &bull; Kadar 2,5%</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        ...
                        <table class="ketentuan-table">
                            <thead>
                                <tr>
                                    <th>Jenis Ternak</th>
                                    <th>Nisab</th>
                                    <th>Kewajiban Tradisional</th>
                                    <th>Pendekatan Kontemporer</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="font-medium text-gray-800">Unta</td>
                                    <td><span class="font-bold text-green-700">5 ekor</span></td>
                                    <td class="text-gray-500">5–9 ekor: 1 ekor kambing betina<br>10–14 ekor: 2 ekor kambing
                                    </td>
                                    <td class="text-gray-500">2,5% dari nilai total</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Sapi / Kerbau</td>
                                    <td><span class="font-bold text-green-700">30 ekor</span></td>
                                    <td class="text-gray-500">30–39 ekor: 1 ekor tabi'<br>40–59 ekor: 1 ekor musinnah</td>
                                    <td class="text-gray-500">2,5% dari nilai total</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Kambing / Domba</td>
                                    <td><span class="font-bold text-green-700">40 ekor</span></td>
                                    <td class="text-gray-500">40–120 ekor: 1 ekor kambing<br>121–200 ekor: 2 ekor kambing
                                    </td>
                                    <td class="text-gray-500">2,5% dari nilai total</td>
                                </tr>
                            </tbody>
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: 30 sapi &times; Rp 15.000.000 = Rp
                            450.000.000 &times; 2,5% = Rp 11.250.000</span>
                    </div>
                    <div class="note-box anim-ready" data-delay="600">
                        Syarat wajib zakat ternak: (1) Digembalakan bebas sepanjang tahun, (2) Tidak digunakan untuk
                        bekerja,
                ...
                <section id="zakat-perniagaan" class="scroll-mt-28 panduan-section" data-section-anim="springpop">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 anim-ready"
                        ...
                        <table class="ketentuan-table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-medium text-gray-800">Stok barang dagangan</td>
                                    <td><span class="text-green-600 font-bold">Ya (+)</span></td>
                                    <td class="text-gray-500">Dinilai berdasarkan harga pasar saat haul</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Kas dan rekening usaha</td>
                                    <td><span class="text-green-600 font-bold">Ya (+)</span></td>
                                    <td class="text-gray-500">Termasuk uang tunai dan saldo bank usaha</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Piutang yang dapat ditagih</td>
                                    <td><span class="text-green-600 font-bold">Ya (+)</span></td>
                                    <td class="text-gray-500">Piutang yang hampir pasti akan tertagih</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Peralatan / mesin produksi</td>
                                    <td><span class="text-red-500 font-bold">Tidak</span></td>
                                    <td class="text-gray-500">Aset tetap operasional tidak termasuk zakat</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Hutang dagang jatuh tempo</td>
                                    <td><span class="text-red-500 font-bold">Dikurang (&minus;)</span></td>
                                    <td class="text-gray-500">Hutang yang jatuh tempo dalam 1 tahun ke depan</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="note-box anim-ready" data-delay="700">
                        Zakat perniagaan mencakup semua jenis usaha: toko fisik, bisnis online, properti yang
                        diperjualbelikan,
                        hingga usaha jasa yang memiliki piutang. Usaha yang baru berjalan kurang dari 1 tahun belum wajib
                        zakat perniagaan.
                    </div>
                </section>
                ...
                <section id="zakat-rikaz" class="scroll-mt-28 panduan-section" data-section-anim="diagonal">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">Tanpa Nisab &bull; Tanpa Haul &bull; Kadar
                        20%</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        Rikaz adalah harta karun atau harta peninggalan dari zaman sebelum Islam (zaman jahiliyah) yang
                        ditemukan
                        terpendam di dalam tanah. Berbeda dengan luqathah (barang temuan biasa). Tidak ada syarat nisab
                        maupun haul —
                        wajib dizakati langsung saat ditemukan. Dasar: HR. Bukhari &amp; Muslim "Pada rikaz wajib seperlima
                        (khums)."
                    </p>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        @php
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: Rp 50.000.000 &times; 20% = Rp
                            10.000.000</span><br>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 anim-ready"
                        ...
                        <table class="ketentuan-table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-medium text-gray-800">Emas temuan</td>
                                    <td class="text-gray-500">Berat (gram) &times; harga emas BAZNAS &times; 20%</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Uang / Logam kuno</td>
                                    <td class="text-gray-500">Nilai pasar / nilai taksiran &times; 20%</td>
                                </tr>
                                <tr>
                                    <td class="font-medium text-gray-800">Barang berharga lainnya</td>
                                    <td class="text-gray-500">Estimasi nilai pasar wajar &times; 20%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="note-box-amber anim-ready" data-delay="700">
                        Rikaz berbeda dengan luqathah (barang temuan pemiliknya tidak diketahui). Rikaz adalah harta
                        peninggalan
                        zaman jahiliyah. Konsultasikan dengan ulama untuk penentuan status harta temuan Anda sebelum
                        membayar zakat.
                    </div>
                </section>
                ...
                <section id="fidyah" class="scroll-mt-28 panduan-section" data-section-anim="softdrift">
                    ...
                    <span class="zakat-type-badge anim-ready" data-delay="100">675 gram/hari &bull; Per Hari Puasa
                        Ditinggalkan</span>
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="150">
                        Kewajiban bagi yang tidak mampu berpuasa Ramadhan secara permanen (sakit kronis, lansia yang sudah
                        sangat lemah).
                    ...
                    <div class="formula-box mb-4 anim-ready" data-delay="500">
                        ...
                        <span class="text-gray-400 font-sans text-xs ml-3">Contoh: Rp 14.000 &times; 30 hari = Rp
                            420.000</span>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 anim-ready"
                        data-delay="600">
                        <table class="ketentuan-table">
                            <thead>
                                <tr>
                                    <th>Yang Wajib Fidyah</th>
                                    <th>Yang Tidak Wajib Fidyah</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                        ...
                        @foreach ($metodeCards as $i => $mc)
                            <div class="method-card anim-ready" data-delay="{{ 150 + $i * 120 }}">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2.5">Alur Status
                                    </p>
                                    @if ($mc['alurType'] === 'pill')
                                        <div class="flex items-center gap-2 flex-wrap">
                                            ...
                                            <span class="status-pill"
                                                style="background:#dcfce7;color:#15803d;border-color:rgba(22,163,74,0.28);">Terverifikasi</span>
                                        </div>
                                        ...
                                        <div class="space-y-2">
                                            @foreach ($mc['alur'] as $status => $ket)
                                                <div class="alur-item">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="text-xs font-semibold text-gray-700">{{ $status }}</span>
                ...
                <section id="metode-pembayaran" class="scroll-mt-28 panduan-section" data-section-anim="wavein">
                    ...
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="100">
                        Tersedia enam metode pembayaran. Ketersediaannya bergantung pada jenis zakat dan metode penerimaan
                        yang dipilih.
                    </p>
                        ...
                        @php
                            $metodeBayar = [
                                [
                                    ...
                                    'cat_cls' => 'bg-green-100 text-green-700',
                                    'desc' =>
                                ...
                                [
                                    ...
                                    'cat_cls' => 'bg-amber-100 text-amber-700',
                                    'desc' =>
                                ...
                                [
                                    ...
                                    'cat_cls' => 'bg-blue-100 text-blue-700',
                                    'desc' =>
                                ...
                                [
                                    ...
                                    'cat_cls' => 'bg-purple-100 text-purple-700',
                                    'desc' =>
                            ...
                            <div class="info-card flex gap-4 items-start anim-ready" data-delay="{{ $i * 80 }}">
                                <div class="flex-1 min-w-0">
                                    <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                        ...
                                        <span
                                            class="text-xs font-semibold px-2.5 py-0.5 rounded-full {{ $m['cat_cls'] }}">{{ $m['catatan'] }}</span>
                                    </div>
                                    <p class="text-xs text-gray-500 leading-relaxed mb-2.5">{{ $m['desc'] }}</p>
                                    <div class="flex flex-wrap gap-1.5">
                                        @foreach ($m['tersedia'] as $t)
                                            <span
                                                class="text-xs border border-green-100 bg-green-50 text-green-700 px-2.5 py-0.5 rounded-full font-medium">{{ $t }}</span>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-2xl p-5 anim-ready" data-delay="500">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            ...
                            @foreach ($statusList as $i => $s)
                                <div class="bg-white border border-gray-200 rounded-xl p-3.5 anim-ready"
                                    data-delay="{{ 550 + $i * 80 }}">
                                    <div class="flex items-center gap-2 mb-2">
                                        <div class="w-2.5 h-2.5 rounded-full flex-shrink-0"
                                            style="background:{{ $s['dot'] }}"></div>
                ...
                <section id="mustahik" class="scroll-mt-28 panduan-section" data-section-anim="badgeburst">
                    ...
                    <p class="text-gray-500 leading-relaxed mb-5 text-sm anim-ready" data-delay="100">
                        Allah SWT menetapkan dalam QS. At-Taubah: 60 bahwa zakat hanya boleh disalurkan kepada delapan
                        golongan berikut.
                ...
                <div class="cta-block anim-ready" data-anim="floatin" data-delay="0">
                    <div class="relative z-10">
                        ...
                        <p class="text-green-100 text-sm mb-6 max-w-md mx-auto leading-relaxed">
                            Pilih metode penerimaan yang paling mudah bagi Anda. Zakat langsung tersalurkan kepada yang
                            berhak.
                        </p>
        ...
        (function() {
            ...
            function animateSection(section) {
                ...
                formulas.forEach(function(f) {
                    setTimeout(function() {
                        f.classList.add('formula-revealed');
                    }, 320);
                });
