...
@section('content')
    ...
    @include('partials.landing.page-hero', [
        ...
        'heroSubtitle' =>
            'Informasi terkini, edukasi zakat, dan panduan seputar pengelolaan zakat, infak, serta sedekah untuk kehidupan yang lebih berkah.',
    ])
    ...
    <style>
        ...
        .bul-card__thumb-link {
            display: block;
            position: relative;
            /* ← wajib untuk badge & caption absolute */
            width: 100%;
            aspect-ratio: 16 / 9;
            overflow: hidden;
            background: #f0fdf4;
            ...
            <div class="bul-search-row">
                <form action="{{ route('artikel.index') }}" method="GET"
                    ...
                    <div class="bul-search-wrap">
                        <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari buletin..."
                ...
                @empty
                    <div class="bul-empty">
                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                            ...
                            <path d="M18 20h20M18 28h14M18 36h8" stroke="#86efac" stroke-width="2.5"
