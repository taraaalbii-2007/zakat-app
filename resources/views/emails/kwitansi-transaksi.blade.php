...
<head>
    ...
    <style type="text/css">
        ...
        body { margin: 0 !important; padding: 0 !important; background-color: #f0f4f0; width: 100% !important; }
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
        <td align="center" valign="top">
            ...
            <!-- Card -->
            <table role="presentation" class="email-container" width="580" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                    <td class="header-padding"
                        style="background:linear-gradient(160deg, #1a4030 0%, #2d6040 60%, #3a7a50 100%);
                            ...
                            <tr>
                                <td align="center" style="padding-bottom:14px;">
                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="width:52px; height:52px; background:rgba(255,255,255,0.15);
                                                        border:2px solid rgba(255,255,255,0.3); border-radius:50%;
                                                        text-align:center; vertical-align:middle; font-size:22px; line-height:52px;">
                                                ✓
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <p style="margin:0 0 8px; color:#ffffff; font-size:22px; font-weight:700;
                        ...
                        <p style="margin:0; color:rgba(255,255,255,0.8); font-size:14px;
                            ...
                            Transaksi Anda di <strong style="color:#ffffff;">{{ $appName }}</strong> telah tercatat
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="content-padding" style="padding:24px 40px 0;">
                        ...
                        <p style="margin:0 0 14px; color:#374151; font-size:10px; font-weight:700;
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <tr style="background-color:#f8faf8;">
                                <td width="44%" style="padding:10px 14px; font-size:12px; font-weight:600;
                                ...
                                <td width="4%" style="padding:10px 4px; color:#9ca3af; font-size:12px;
                                    text-align:center; border-bottom:1px solid #e5e7eb; font-family:'Segoe UI',Arial,sans-serif;">:</td>
                                <td style="padding:10px 14px; color:#111827; font-size:12px; font-weight:600;
                            ...
                            <tr>
                                ...
                                <td style="padding:10px 4px; color:#9ca3af; font-size:12px;
                                    text-align:center; border-bottom:1px solid #e5e7eb;">:</td>
                                <td style="padding:10px 14px; color:#111827; font-size:13px; font-weight:500;
                                    border-bottom:1px solid #e5e7eb; font-family:'Segoe UI',Arial,sans-serif;">
                            ...
                            <tr style="background-color:#f8faf8;">
                                ...
                                <td style="padding:10px 4px; color:#9ca3af; font-size:12px;
                                    text-align:center; border-bottom:1px solid #e5e7eb;">:</td>
                                <td style="padding:10px 14px; color:#1a4030; font-size:13px; font-weight:700;
                                    border-bottom:1px solid #e5e7eb; font-family:'Segoe UI',Arial,sans-serif;">
                                    {{ $t->muzakki_nama }}
                                </td>
                            </tr>
                            ...
                            <tr @if(!$t->jumlah_jiwa) style="background-color:#f8faf8;" @endif>
                                ...
                                <td style="padding:10px 4px; color:#9ca3af; font-size:12px;
                                    text-align:center; border-bottom:1px solid #e5e7eb;">:</td>
                                <td style="padding:10px 14px; color:#111827; font-size:13px; font-weight:600;
                                    border-bottom:1px solid #e5e7eb; font-family:'Segoe UI',Arial,sans-serif;">
                            ...
                            <tr @if(!$t->jumlah_jiwa) style="background-color:#f8faf8;" @endif>
                                ...
                                <td style="padding:10px 4px; color:#9ca3af; font-size:12px;
                                    text-align:center; border-bottom:1px solid #e5e7eb;">:</td>
                                <td style="padding:10px 14px; color:#1a4030; font-size:15px; font-weight:700;
                                    border-bottom:1px solid #e5e7eb; font-family:'Segoe UI',Arial,sans-serif;">
                            ...
                            <tr>
                                ...
                                <td style="padding:10px 4px; color:#9ca3af; font-size:12px; text-align:center;">:</td>
                ...
                <tr>
                    <td style="background-color:#f8faf8; padding:20px 40px; text-align:center;
                        ...
                        @if($logoBase64)
                        <img src="{{ $logoBase64 }}" alt="{{ $appName }}" width="32" height="32"
                             style="width:32px; height:32px; border-radius:50%; object-fit:cover;
                                    display:inline-block; margin-bottom:8px;">
                        @endif

                        <p style="margin:0 0 3px; color:#1a4030; font-size:14px; font-weight:700;
                                  font-family:'Segoe UI',Arial,sans-serif;">
                            {{ $appName }}
                        </p>
