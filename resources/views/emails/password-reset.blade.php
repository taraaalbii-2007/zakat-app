                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px; text-align:center; border-bottom:1px solid #f0f0f0;">
                            ...
                            <p style="margin:0; color:#6b7280; font-size:14px; line-height:1.6;">
                                Atur ulang password akun Anda di <strong style="color:#2d6936;">{{ optional($config)->nama_aplikasi ?? 'Niat Zakat' }}</strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px 48px;">
                            ...
                            <p style="margin:0 0 28px; font-family:'Courier New', Courier, monospace; font-size:12px; color:#374151; line-height:1.6; word-break:break-all;">
                                {{ $resetUrl }}
                            </p>
