{{-- resources/views/muzakki/profil/edit-password.blade.php --}}
@extends('layouts.app')
...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden">
        ...
        <div class="px-4 sm:px-6 py-3 sm:py-5 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-gray-500 mt-1">Perbarui kata sandi akun Anda</p>
                </div>
        ...
        <div class="p-4 sm:p-6">
            ...
            <form action="{{ route('muzakki.profil.password.update') }}" method="POST" class="w-full">
                @csrf
                @method('PUT')
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        <input type="password" name="current_password" id="current_password"
                            class="w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition @error('current_password') border-red-500 @enderror"
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        <input type="password" name="password" id="password"
                            class="w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition @error('password') border-red-500 @enderror"
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            class="w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
                ...
                <div class="w-full mb-5">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span id="password-strength-text" class="text-xs font-medium text-gray-400 whitespace-nowrap">Kekuatan Password</span>
                    </div>
                ...
                {{-- Peringatan --}}
                <div class="w-full mb-6 p-3 sm:p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-xs sm:text-sm text-amber-700">
                            Setelah mengubah password, Anda akan <strong>otomatis logout</strong> dan harus login ulang menggunakan password baru.
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit"
                        class="inline-flex items-center px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white text-sm font-medium rounded-lg transition shadow-sm">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @else
            <div class="w-full flex items-start gap-3 p-4 bg-blue-50 border border-blue-100 rounded-lg">
...
if (passwordInput) {
    passwordInput.addEventListener('input', function () {
        ...
        const strength = [hasLength, hasUppercase, hasLowercase, hasNumber].filter(Boolean).length * 25;
        strengthBar.style.width = strength + '%';

        const levels = {
            25:  ['bg-red-500',    'Lemah',  'text-red-500'],
            50:  ['bg-orange-500', 'Cukup',  'text-orange-500'],
            75:  ['bg-yellow-500', 'Sedang', 'text-yellow-500'],
            100: ['bg-green-500',  'Kuat',   'text-green-500'],
        };
        const [barClass, label, textClass] = levels[strength] ?? ['bg-gray-300', 'Kekuatan Password', 'text-gray-400'];
        strengthBar.className    = `h-full ${barClass} transition-all duration-300`;
        strengthText.textContent = label;
        strengthText.className   = `text-xs font-medium whitespace-nowrap ${textClass}`;
    });
}
</script>
@endpush