        ...
        <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                ...
                <div class="flex-shrink-0 mx-auto sm:mx-0">
                    <div class="relative">
                        ...
                        <span class="absolute bottom-0.5 right-0.5 w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 border-white
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div class="border {{ $item['color'] }} rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 mb-2">
                            <svg class="w-4 h-4 {{ $item['text'] }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    @foreach([
                        ['Nama Lengkap',  $muzakki->nama],
                        ['Nomor Telepon', $muzakki->telepon],
                        ['Email',         $muzakki->email],
                        ['NIK',           $muzakki->nik],
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Metode Login</label>
                        @if($user->is_google_user)
