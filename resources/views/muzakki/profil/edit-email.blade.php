{{-- resources/views/muzakki/profil/edit-email.blade.php --}}
@extends('layouts.app')
...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 sm:p-6">
            ...
            <form action="{{ route('muzakki.profil.email.update') }}" method="POST" class="w-full">
                @csrf
                @method('PUT')
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="email" name="email" id="email"
                            value="{{ old('email') }}"
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition @error('email') border-red-500 @enderror"
                            placeholder="emailbaru@contoh.com" required>
                    </div>
                    @error('email')
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-xs sm:text-sm text-blue-700 space-y-1">
                            ...
                            <ul class="list-disc list-inside space-y-0.5 text-blue-600">
                                ...
                                <li>Login selanjutnya menggunakan email baru</li>
                            </ul>
                        </div>
                    </div>
                </div>
