...
@section('content')
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden">
            <div
                class="px-4 sm:px-6 py-4 bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 border-b border-green-100">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-green-100 border border-green-200 flex items-center justify-center flex-shrink-0">
            ...
            <div id="panelPilihMetode" class="p-4 sm:p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                    ...
                    <button type="button" onclick="pilihMetode('daring')"
                        ...
                        <div
                            class="w-16 h-16 rounded-2xl bg-indigo-100 group-hover:bg-indigo-200 flex items-center justify-center transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Bayar via Transfer Bank atau QRIS. Bukti dikirim ke amil
                                untuk dikonfirmasi.</p>
                        </div>
                        <span
                            class="px-3 py-1 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-700">Direkomendasikan</span>
                    </button>
                    ...
                    <button type="button" onclick="pilihMetode('dijemput')"
                        ...
                        <div
                            class="w-16 h-16 rounded-2xl bg-orange-100 group-hover:bg-orange-200 flex items-center justify-center transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Amil datang ke lokasi Anda. Zakat bisa dibayar tunai,
                                transfer, atau beras.</p>
                        </div>
                        <span class="px-3 py-1 rounded-full text-xs font-semibold bg-orange-100 text-orange-700">Amil ke
                            lokasi Anda</span>
                    </button>
                </div>
            </div>
            ...
            <div id="panelDaring" class="hidden">
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
                        ...
                        <div class="overflow-y-auto flex-1 px-6 py-5 space-y-5" id="doaScrollArea">
                            ...
                            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                                <h4 class="text-xs font-bold text-amber-900 uppercase tracking-wider mb-3">Niat Zakat Fitrah
                                </h4>
                                ...
                                <p class="text-xs text-gray-500 mt-1.5">
                                    Artinya: <em>"Aku niat mengeluarkan zakat fitrah dari diriku sendiri, fardhu karena
                                        Allah Ta'ala."</em>
                                </p>
                            </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                <h4 class="text-xs font-bold text-blue-900 uppercase tracking-wider mb-3">Niat Zakat Mal
                                    (Harta)</h4>
                                <p class="text-right text-lg leading-loose text-gray-800 font-arabic mb-2">
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                                <h4 class="text-xs font-bold text-green-900 uppercase tracking-wider mb-3">Doa Setelah Zakat
                                </h4>
                                <p class="text-right text-lg leading-loose text-gray-800 font-arabic mb-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1.5">
                                    Artinya: <em>"Ya Allah, jadikanlah ini sebagai keuntungan dan jangan jadikan
                                        kerugian."</em>
                                </p>
                            </div>
                            ...
                            <div class="bg-purple-50 border border-purple-200 rounded-xl p-4">
                                <h4 class="text-xs font-bold text-purple-900 uppercase tracking-wider mb-2">Keutamaan
                                    Berzakat</h4>
                                <div class="space-y-2 text-xs text-purple-800">
                                    <p>• <strong>Membersihkan harta</strong> — Zakat mensucikan harta dari hal-hal yang
                                        syubhat</p>
                                    <p>• <strong>Mendapat keberkahan</strong> — Allah melipatgandakan pahala orang yang
                                        berzakat</p>
                                    <p>• <strong>Menghapus dosa</strong> — Zakat dapat menjadi kafarat (penghapus) dosa-dosa
                                        kecil</p>
                        ...
                        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 flex-shrink-0">
                            <div class="mb-3 flex items-start gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-xl">
                                <input type="checkbox" id="chkSudahBaca"
                                    class="w-4 h-4 text-green-600 border-gray-300 rounded mt-0.5 cursor-pointer">
                                <label for="chkSudahBaca" class="text-xs text-yellow-800 cursor-pointer leading-relaxed">
                                    Saya telah membaca niat dan doa zakat di atas, serta niat untuk menunaikan kewajiban
                                    zakat dengan ikhlas karena Allah Ta'ala.
                                </label>
                            </div>
                            ...
                            <p class="text-xs text-gray-400 text-center mt-2">Centang kotak di atas untuk mengaktifkan
                                tombol</p>
                        </div>
                    </div>
                </div>
                ...
                <form id="formDaring" action="{{ route('transaksi-daring-muzakki.store') }}" method="POST"
                    ...
                    <div class="mb-7">
                        <div class="flex items-center max-w-lg mx-auto">
                            <div class="flex flex-col items-center flex-1">
                                <div id="dDot1"
                                    class="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold ring-4 ring-indigo-500/20 bg-indigo-600 text-white">
                                    1</div>
                    ...
                    <div id="dStep1" class="dstep-panel">
                        <h3
                            class="text-sm font-bold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center gap-2">
                            <span
                                class="inline-flex w-6 h-6 rounded-full bg-indigo-600 text-white text-xs items-center justify-center font-bold">1</span>
                            Pilih Jenis Zakat
                        </h3>

                        {{-- ====================================================
                     DATA MUZAKKI — NAMA & EMAIL READONLY
                ...
                ==================================================== --}}
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4 mb-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {{-- NAMA — READONLY --}}
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Nama Lengkap <span
                                            class="text-red-500">*</span> <span
                                            class="text-xs font-bold text-gray-600">(readonly)</span></label>
                                ...
                                {{-- EMAIL — READONLY --}}
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Email <span
                                            class="text-xs font-bold text-gray-600">(readonly)</span></label>
                                ...
                                {{-- TELEPON — BISA DIEDIT --}}
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Telepon / WA <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="muzakki_telepon"
                                        value="{{ old('muzakki_telepon', $muzakkiData['telepon']) }}"
                                        class="w-full px-3 py-2 text-sm border border-gray-300 bg-white rounded-lg focus:outline-none focus:border-indigo-500 transition-all"
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="muzakki_alamat" rows="2"
                                        class="w-full px-3 py-2 text-sm border border-gray-300 bg-white rounded-lg focus:outline-none focus:border-indigo-500 transition-all resize-none"
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Jenis Zakat <span
                                            class="text-red-500">*</span></label>
                                ...
                                {{-- Tipe Spesifik — hanya tampil "Tunai" jika Fitrah --}}
                                <div id="dWrapTipe" class="hidden">
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Tipe Spesifik <span
                                            class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Program Zakat <span
                            ...
                            <div id="dPanelFitrahTunai" class="hidden space-y-4">
                                <div class="bg-amber-50 border border-amber-200 rounded-xl p-3">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <div class="bg-white rounded-lg border border-amber-200 p-2 text-center">
                                            <p class="font-bold text-amber-800 text-sm">{{ $zakatFitrahInfo['beras_kg'] }}
                                                kg</p>
                                            <p class="text-xs text-amber-600">per jiwa</p>
                                        </div>
                                        <div class="bg-white rounded-lg border border-amber-200 p-2 text-center">
                                            <p class="font-bold text-amber-800 text-sm">
                                                {{ $zakatFitrahInfo['beras_liter'] }} ltr</p>
                                            <p class="text-xs text-amber-600">per jiwa</p>
                                        </div>
                                        <div class="bg-white rounded-lg border border-green-200 p-2 text-center">
                                            <p class="font-bold text-green-700 text-sm">Rp
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Jumlah Jiwa <span
                                                class="text-red-500">*</span></label>
                                        <input type="number" name="jumlah_jiwa" id="dJiwa" value="1"
                                            min="1" step="1"
                                            class="w-full px-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-indigo-500 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Nominal/Jiwa (Rp)
                                        ...
                                        <div class="relative"><span
                                            ...
                                            <input type="number" name="nominal_per_jiwa" id="dNominalJiwa"
                                                value="{{ $zakatFitrahInfo['nominal_per_jiwa'] }}" min="1000"
                                                step="1000"
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div id="dDaftarNama">
                                            ...
                                            <div class="flex items-center gap-2 nama-jiwa-row" data-index="0">
                                                <div
                                                    class="flex-shrink-0 w-7 h-7 rounded-full bg-indigo-600 text-white text-xs font-bold flex items-center justify-center nama-jiwa-num">
                                                    1</div>
                            ...
                            <div id="dPanelMal" class="hidden space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Total Nilai Harta (Rp)
                                        <span class="text-red-500">*</span></label>
                                    <div class="relative"><span
                                            class="absolute left-3.5 top-1/2 -translate-y-1/2 text-sm text-gray-400">Rp</span>
                                        <input type="number" name="nilai_harta" id="dHarta" min="0"
                                            step="1000" placeholder="Total harta yang wajib dizakatkan"
                                            class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-indigo-500 transition-all">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Nisab (Rp) <span
                                                class="text-xs text-gray-400 font-normal">(opsional)</span></label>
                                        <div class="relative"><span
                                                class="absolute left-3.5 top-1/2 -translate-y-1/2 text-sm text-gray-400">Rp</span>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Persentase Zakat
                                            (%)</label>
                                        <input type="number" name="persentase_zakat" id="dPersen" value="2.5"
                        ...
                        <div class="flex justify-end mt-5 pt-4 border-t border-gray-100">
                            <button type="button" onclick="dGoStep(2)"
                                class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-indigo-500/25 transition-all">
                                Selanjutnya <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <div id="dStep2" class="dstep-panel hidden">
                        <h3
                            class="text-sm font-bold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center gap-2">
                            <span
                                class="inline-flex w-6 h-6 rounded-full bg-indigo-600 text-white text-xs items-center justify-center font-bold">2</span>
                            Metode Pembayaran
                        </h3>
                        <div class="space-y-5">
                            <div
                                class="bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 flex items-start gap-2.5">
                                <svg class="w-4 h-4 text-indigo-600 flex-shrink-0 mt-0.5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p class="text-xs text-indigo-800">Pilih metode pembayaran. Bukti transfer akan
                                    dikonfirmasi oleh amil.</p>
                            </div>

                            {{-- Metode pembayaran dropdown FULL WIDTH --}}
                            <div>
                                ...
                                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                    ...
                                    @if ($rekeningMasjidList->isNotEmpty())
                                        @foreach ($rekeningMasjidList as $rek)
                                            <div
                                                class="bg-white border border-blue-200 rounded-lg p-3 flex items-center justify-between mb-2 last:mb-0">
                                                <div>
                                                    <p class="text-xs font-bold text-gray-800">{{ $rek->nama_bank }}</p>
                                                    <p
                                                        class="text-sm font-mono font-bold text-gray-900 tracking-wider mt-0.5">
                                                ...
                                                <button type="button" onclick="salin('{{ $rek->nomor_rekening }}')"
                                                    class="text-xs text-blue-600 hover:bg-blue-100 px-2.5 py-1.5 rounded-lg transition-all font-semibold">Salin</button>
                                            </div>
                                        @endforeach
                                    @else
                                        <p class="text-xs text-gray-500 italic">Belum ada rekening aktif. Hubungi pengurus
                                            masjid.</p>
                                    @endif
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Screenshot Bukti Pembayaran
                                        <span class="text-xs text-gray-400 font-normal">(opsional)</span></label>
                                    <div id="dPrvTransfer"
                                        class="h-28 rounded-xl bg-gray-50 border-2 border-dashed border-gray-300 flex items-center justify-center mb-2 overflow-hidden cursor-pointer hover:border-indigo-400 transition-all"
                                        onclick="document.getElementById('dInpTransfer').click()">
                                        <div class="text-center"><svg class="w-7 h-7 text-gray-300 mx-auto mb-1"
                                    ...
                                    <input type="file" name="bukti_transfer" id="dInpTransfer" accept="image/*"
                                        class="hidden" onchange="prvBuktiD(this,'dPrvTransfer')">
                                </div>
                            </div>
                            ...
                            <div id="dInfoQris" class="hidden space-y-3">
                                <div class="bg-purple-50 border border-purple-200 rounded-xl p-4">
                                    ...
                                    @if ($konfigurasiQris && !empty($konfigurasiQris->qris_image_path))
                                        <div class="flex justify-center mb-3">
                                            <div
                                                class="bg-white p-4 rounded-xl border border-purple-200 shadow-sm w-full max-w-sm">
                                                <img src="{{ $konfigurasiQris->qris_image_url }}"
                                                    class="w-full object-contain" alt="QRIS">
                                            </div>
                                        </div>
                                    @else
                                        <div class="bg-white border border-purple-200 rounded-lg p-4 text-center mb-3">
                                            <p class="text-xs text-gray-500">Hubungi pengurus masjid untuk mendapatkan kode
                                                QRIS.</p>
                                        </div>
                                    @endif
                                </div>
                                <div>
                                    ...
                                    <input type="file" name="bukti_qris" id="dInpQris" accept="image/*"
                                        class="hidden" onchange="prvBuktiD(this,'dPrvQris')">
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Jumlah Dibayar (Rp) <span
                                        class="text-xs text-gray-400">(opsional — lebih = infaq)</span></label>
                                <div class="relative"><span
                                        class="absolute left-3.5 top-1/2 -translate-y-1/2 text-sm text-gray-400">Rp</span>
                                    <input type="number" name="jumlah_dibayar" id="dJmlDibayar" min="0"
                                        step="1000" placeholder="Kosongkan = bayar pas sesuai zakat"
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-indigo-500 transition-all">
                                </div>
                                <p class="text-xs text-gray-400 mt-1">Bayar lebih → kelebihan dicatat sebagai
                                    <strong>infaq</strong></p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Keterangan <span
                                        class="text-xs text-gray-400 font-normal">(opsional)</span></label>
                                <textarea name="keterangan" rows="2" placeholder="Untuk program tertentu, atas nama keluarga, dll."
                                    class="w-full px-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-indigo-500 transition-all resize-none"></textarea>
                            </div>
                        </div>
                    ...
                    <div id="dStep3" class="dstep-panel hidden">
                        <h3
                            class="text-sm font-bold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center gap-2">
                            <span
                                class="inline-flex w-6 h-6 rounded-full bg-indigo-600 text-white text-xs items-center justify-center font-bold">3</span>
                            Konfirmasi Transaksi
                        </h3>
                        <div class="space-y-4">
                            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                                <p class="text-xs font-bold text-green-800 uppercase tracking-wide mb-3">Ringkasan
                                    Pembayaran</p>
                                <table class="w-full text-sm">
                                    ...
                                    <tr class="border-b border-green-100">
                                        ...
                                        <td class="font-bold text-green-700" id="dRingJumlah">-</td>
                                    </tr>
                                    <tr class="border-b border-green-100">
                                        <td class="text-gray-500 py-1.5">Metode Bayar</td>
                                        <td class="font-bold text-gray-900" id="dRingMetode">-</td>
                                    </tr>
                                    <tr class="border-b border-green-100" id="dRingJiwaRow">
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-bold text-amber-600">Menunggu konfirmasi amil</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 flex items-start gap-2">
                                ...
                                <p class="text-xs text-blue-800">Amil akan mendapat notifikasi dan segera memverifikasi
                                    pembayaran Anda.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
                            ...
                            <button type="submit" id="btnSimpanDaring"
                                class="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-green-500/25 hover:shadow-green-500/40 transition-all">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                                </svg>
            ...
            <div id="panelDijemput" class="hidden">
                <form id="formDijemput" action="{{ route('transaksi-daring-muzakki.store') }}" method="POST"
                    ...
                    <div class="mb-5 bg-orange-50 border border-orange-200 rounded-xl px-4 py-3 flex items-start gap-2.5">
                        <svg class="w-4 h-4 text-orange-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <p class="text-xs text-orange-800"><strong>Metode Dijemput:</strong> Amil akan datang ke lokasi
                            Anda untuk mengambil zakat. Detail jenis dan jumlah zakat akan dilengkapi oleh amil saat
                            menjemput.</p>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {{-- NAMA — READONLY --}}
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Nama Lengkap <span
                                            class="text-red-500">*</span> <span
                                            class="text-xs font-bold text-gray-600">(readonly)</span></label>
                                ...
                                {{-- EMAIL — READONLY --}}
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Email <span
                                            class="text-xs font-bold text-gray-600">(readonly)</span></label>
                                    <input type="email" name="muzakki_email" value="{{ $muzakkiData['email'] }}"
                                        readonly
                                        class="w-full px-4 py-2.5 text-sm border border-gray-200 bg-gray-100 rounded-xl cursor-not-allowed text-gray-600">
                                ...
                                {{-- TELEPON — BISA DIEDIT --}}
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Telepon / WA <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="muzakki_telepon"
                                        value="{{ old('muzakki_telepon', $muzakkiData['telepon']) }}"
                                        class="w-full px-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-orange-400 transition-all"
                                        placeholder="Masukkan nomor telepon">
                                </div>
                                ...
                                {{-- ALAMAT — BISA DIEDIT --}}
                                <div class="sm:col-span-2">
                                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Alamat Lengkap
                                        Penjemputan <span class="text-red-500">*</span></label>
                                    <textarea name="muzakki_alamat" id="djAlamat" rows="2"
                                        class="w-full px-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-orange-400 transition-all resize-none"
                        ...
                        <div>
                            ...
                            @if ($amilList->isNotEmpty())
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    @foreach ($amilList as $amil)
                                        <label
                                            class="amil-card flex items-center gap-3 p-3.5 rounded-xl border-2 cursor-pointer transition-all border-gray-200 hover:border-orange-400 hover:bg-orange-50/50">
                                            <input type="radio" name="amil_id" value="{{ $amil->id }}"
                                                class="w-4 h-4 text-orange-500 border-gray-300 amil-radio">
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    {{ $amil->pengguna->username ?? 'Amil' }}</p>
                                                <p class="text-xs text-gray-500 truncate">
                                                    {{ $amil->pengguna->email ?? '' }}</p>
                                            </div>
                                            <div
                                                class="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0">
                                                <span
                                                    class="text-sm font-bold text-orange-700">{{ strtoupper(substr($amil->pengguna->username ?? 'A', 0, 1)) }}</span>
                                            </div>
                                        </label>
                                    @endforeach
                                </div>
                            @else
                                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-center">
                                    <p class="text-sm text-yellow-800">Belum ada amil aktif. Silakan pilih metode daring.
                                    </p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            <button type="button" onclick="getGPS()"
                                class="inline-flex items-center gap-2 px-4 py-2.5 bg-orange-100 hover:bg-orange-200 text-orange-800 text-sm font-medium rounded-xl transition-all">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <textarea name="keterangan" rows="2" placeholder="Patokan lokasi, waktu yang tersedia, dll."
                                class="w-full px-4 py-2.5 text-sm border border-gray-300 bg-white rounded-xl focus:outline-none focus:border-orange-400 transition-all resize-none"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
                        ...
                        <button type="submit" id="btnSimpanDijemput"
                            class="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-sm font-bold rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
...
@push('scripts')
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                chk.addEventListener('change', function() {
                    if (this.checked) {
                        ...
                        btn.classList.add('bg-gradient-to-r', 'from-green-600', 'to-emerald-600',
                            'hover:from-green-700', 'hover:to-emerald-700', 'cursor-pointer');
                    } else {
                        btn.disabled = true;
                        btn.classList.add('bg-gray-300', 'cursor-not-allowed', 'opacity-60');
                        btn.classList.remove('bg-gradient-to-r', 'from-green-600', 'to-emerald-600',
                            'cursor-pointer');
                    }
                });
            }

            // Jenis zakat change — filter tipe untuk fitrah hanya tampil tunai
            document.getElementById('dJenisId').addEventListener('change', function() {
                ...
                if (list.length > 0) {
                    ...
                    if (isFitrah) {
                        // Untuk Fitrah, hanya tampilkan tipe yang mengandung "tunai"
            ...
            document.getElementById('dTipeId').addEventListener('change', function() {
                ...
                const namaJenis = (jenisEl.options[jenisEl.selectedIndex]?.dataset.nama || '')
            .toLowerCase();
            ...
            document.getElementById('dMetodePembayaran')?.addEventListener('change', function() {
                ...
                if (this.value === 'transfer') document.getElementById('dInfoTransfer').classList.remove(
                    'hidden');
    ...
    `;
        ...
        function dRefreshDots(active) {
            [1, 2, 3].forEach(i => {
                ...
                if (i < active) {
                    ...
                    d.classList.add('bg-indigo-600', 'text-white', 'ring-4', 'ring-indigo-500/20');
                    d.textContent = i;
                } else {
                ...
                if (ln) {
                    ln.classList.toggle('bg-indigo-500', i < active);
        ...
        function dValidateStep(step) {
            if (step === 1) {
                if (!document.getElementById('dJenisId').value) {
                    alert('Pilih jenis zakat terlebih dahulu.');
                    return false;
                }
                if (!document.getElementById('dTipeId').value) {
                    alert('Pilih tipe zakat terlebih dahulu.');
                    return false;
                }
                if (getJumlahZakatD() <= 0) {
                    alert('Jumlah zakat tidak valid. Periksa kembali data yang diisi.');
                    return false;
                }
                return true;
            }
            if (step === 2) {
                ...
                if (!metode) {
                    alert('Pilih metode pembayaran (Transfer atau QRIS).');
                    return false;
                }
                return true;
            }
        ...
        function dUpdateRingkasan() {
            ...
            document.getElementById('dRingMetode').textContent = metode === 'transfer' ? 'Transfer Bank' : (metode ===
                'qris' ? 'QRIS' : '-');

            // Tampilkan info jiwa hanya jika fitrah
        ...
        document.getElementById('formDijemput')?.addEventListener('submit', function(e) {
            ...
            if (!lat) {
                e.preventDefault();
                alert('Lokasi GPS wajib dideteksi. Klik tombol "Dapatkan Lokasi GPS Saya".');
                return;
            }
            if (!amil) {
                e.preventDefault();
            ...
            btn.disabled = true;
            btn.innerHTML =
                '<svg class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg> Memproses...';
        });
        ...
        function prvBuktiD(input, previewId) {
            ...
            if (input.files?.[0]) {
                ...
                r.onload = e => {
                    el.innerHTML = `<img src="${e.target.result}" class="h-full w-full object-contain">`;
                };
        ...
        function salin(teks) {
            navigator.clipboard.writeText(teks).then(() => {
                ...
                el.className =
                    'fixed bottom-5 right-5 bg-gray-900 text-white text-xs px-4 py-2.5 rounded-xl shadow-xl z-50';
