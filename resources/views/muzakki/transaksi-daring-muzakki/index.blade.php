...
{{-- ── Statistics Cards ── --}}
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4 animate-slide-up">
    ...
    <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4">
        <div class="flex items-center">
            ...
            <div class="ml-3 flex-1 min-w-0">
                ...
                <p class="text-base sm:text-xl md:text-2xl font-semibold text-gray-900 break-words">Rp {{ number_format($stats['total_nominal'], 0, ',', '.') }}</p>
