                            ...
                            @foreach ($setorans as $setor)
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $setor->tanggal_setor->format('d M Y') }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <button type="button" data-dropdown-toggle="{{ $setor->uuid }}"
                    ...
                    @foreach ($setorans as $setor)
                        ...
                        <div class="p-4 hover:bg-gray-50 transition-colors">
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex items-center text-xs text-gray-600">
                                            ...
                                            Periode: {{ $setor->periode_dari->format('d M Y') }} &mdash;
                                ...
                                <button type="button" data-dropdown-toggle="{{ $setor->uuid }}"
                                    data-no-setor="{{ $setor->no_setor }}" data-bisa-edit="{{ $bisaEdit ? '1' : '0' }}"
                                    data-bisa-hapus="{{ $bisaHapus ? '1' : '0' }}"
            ...
            document.addEventListener('click', function(e) {
                ...
                if (toggle) {
                    ...
                    requestAnimationFrame(() => {
                        ...
                        if (left < 10) left = 10;
                        if (left + dropdownW > window.innerWidth - 10) left = window.innerWidth -
                            dropdownW - 10;
