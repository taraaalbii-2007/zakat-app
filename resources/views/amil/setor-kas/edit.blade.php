{{-- resources/views/amil/setor-kas/edit.blade.php --}}
@extends('layouts.app')
        ...
        <form action="{{ route('amil.setor-kas.update', $setorKas->uuid) }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_setor" id="tanggal_setor"
                            value="{{ old('tanggal_setor', $setorKas->tanggal_setor->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $setorKas->no_setor }}" disabled
                            class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl bg-gray-50 cursor-not-allowed text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="periode_dari" id="periode_dari"
                            value="{{ old('periode_dari', $setorKas->periode_dari->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="periode_sampai" id="periode_sampai"
                            value="{{ old('periode_sampai', $setorKas->periode_sampai->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="jumlah_disetor" id="jumlah_disetor"
                            value="{{ old('jumlah_disetor', (int) $setorKas->jumlah_disetor) }}"
                            placeholder="0"
                            min="0"
                            step="1000"
                        ...
                        <div class="space-y-2">
                            <div id="foto-preview" class="h-40 rounded-xl border-2 border-dashed border-gray-300 hover:border-primary/50 flex items-center justify-center overflow-hidden bg-gray-50 transition-colors">
                                @if($setorKas->bukti_foto_url)
                                    <img src="{{ $setorKas->bukti_foto_url }}" class="w-full h-full object-contain" id="existing-foto">
                                @else
                                    <div class="text-center text-gray-400" id="foto-placeholder">
                            ...
                            <div class="flex gap-2">
                                ...
                                <label for="bukti_foto" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 cursor-pointer transition-colors">
                                    ...
                                    {{ $setorKas->bukti_foto_url ? 'Ganti Foto' : 'Pilih Foto' }}
                                </label>
                                <button type="button" id="btn-remove-foto" onclick="removeFoto()"
                                    class="{{ $setorKas->bukti_foto_url ? '' : 'hidden' }} px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                    </svg>
                                </button>
                            </div>
                            <p class="text-xs text-gray-400">JPG/PNG, maks 5MB. Kosongkan jika tidak ingin mengubah foto.</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            @if($setorKas->tanda_tangan_amil_url)
                                ...
                                <p class="text-xs text-gray-500">Tanda tangan saat ini. Gambar ulang di bawah untuk menggantinya.</p>
                            @endif
                            ...
                            <p class="text-xs text-gray-400">Gambar tanda tangan baru di area di atas, atau biarkan kosong untuk mempertahankan yang lama.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="keterangan" id="keterangan" rows="3"
                    ...
                    class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('keterangan') border-red-500 @enderror">{{ old('keterangan', $setorKas->keterangan) }}</textarea>
