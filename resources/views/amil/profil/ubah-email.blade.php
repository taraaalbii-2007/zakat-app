{{-- resources/views/amil/profil/ubah-email.blade.php --}}
@extends('layouts.app')
...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 sm:p-6">
            ...
            <form action="{{ route('profil.email.update') }}" method="POST" class="w-full">
                @csrf
                @method('PUT')
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="email" name="email" id="email"
                            value="{{ old('email') }}"
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-primary transition @error('email') border-red-500 @enderror"
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="relative w-full">
                        <input type="password" name="current_password" id="current_password"
                            class="w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-primary transition @error('current_password') border-red-500 @enderror"
