    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 animate-slide-up">
        <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900">{{ number_format($stats['total'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900">{{ number_format($stats['total_verified'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900">{{ number_format($stats['total_pending'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    <p class="text-xs font-medium text-gray-500 truncate">Hari Ini</p>
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900">{{ number_format($stats['total_hari_ini'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-card border border-gray-100 p-4 col-span-2 lg:col-span-1">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900">Rp {{ number_format($stats['total_nominal'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
