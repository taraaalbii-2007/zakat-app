                                                                ...
                                                                <div
                                                                    ...
                                                                    @elseif($trx->fidyah_tipe === 'tunai')
                                                                        ...
                                                                        @if ($trx->jumlah_infaq > 0)
                                                                            <p class="text-xs text-amber-700">Termasuk
                                                                                infaq: Rp
                                                            ...
                                                            @else
                                                                ...
                                                                @if ($trx->jumlah > 0)
                                                                    <div class="flex items-start gap-2">
                                                                        ...
                                                                        <div>
                                                                            <p class="text-xs text-gray-500">Jumlah Zakat
                                                                            </p>
                                                                            <p
                                                                            ...
                                                                            @if ($trx->jumlah_dibayar && $trx->jumlah_dibayar != $trx->jumlah)
                                                                                <p class="text-xs text-gray-500">Dibayar:
                                                                                    Rp
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="space-y-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <span
                                                                    class="inline-block px-2 py-0.5 text-xs font-medium rounded-full bg-green-100 text-green-800">Terverifikasi</span>
                                                            </div>
                                                            @if ($trx->verified_at)
                                                                <div class="flex items-start gap-2">
                                                                    <svg class="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between gap-2">
                                            <h3 class="text-sm font-semibold text-gray-900 truncate">
                                                {{ $trx->muzakki_nama ?? '-' }}</h3>
                                            <span
                                                class="px-2 py-0.5 text-xs font-medium rounded-full bg-green-100 text-green-800 flex-shrink-0">Terverifikasi</span>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap gap-1 mt-1.5">
                                            @if ($isFidyah)
                                                <span
                                                    class="px-2 py-0.5 text-xs font-medium rounded-full bg-amber-100 text-amber-800">Fidyah</span>
                                            @endif
                                            <span
                                                class="px-2 py-0.5 text-xs font-medium rounded-full {{ $warnaMetode }}">
                                                {{ $namaMetode }}
                                ...
                                <div class="bg-gray-50 px-4 py-3 border-t border-gray-100 space-y-3">
                                    ...
                                    @if ($isFidyah)
                                        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 space-y-1.5">
                                            ...
                                            @elseif($trx->fidyah_tipe === 'tunai')
                                                @if ($trx->jumlah > 0)
                                                    <p class="text-xs text-amber-700">Total Dibayar: <strong>Rp
                                                            {{ number_format($trx->jumlah_dibayar ?? $trx->jumlah, 0, ',', '.') }}</strong>
                                                    </p>
                                                @endif
                                                @if ($trx->jumlah_infaq > 0)
                                                    <p class="text-xs text-amber-700">Termasuk infaq: Rp
