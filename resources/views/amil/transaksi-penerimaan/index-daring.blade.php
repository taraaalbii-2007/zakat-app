...
@section('content')
    ...
    {{--
        PERUBAHAN:
        1. Tombol X dihapus — sudah ada tombol "Batal" di bawah
        2. Modal responsive dengan scroll:
           - Container pakai flex flex-col max-h-[90vh]
           - Header & footer flex-shrink-0 (tidak ikut scroll)
           - Body tengah overflow-y-auto flex-1 (scrollable)
    --}}
    <div id="konfirmasi-modal"
        class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-[10000] flex items-center justify-center p-4">
        <div class="w-full max-w-md shadow-xl rounded-2xl bg-white flex flex-col max-h-[90vh]">
