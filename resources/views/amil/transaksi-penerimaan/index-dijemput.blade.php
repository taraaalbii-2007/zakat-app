                        ...
                        <div>
                            ...
                            <select name="status_penjemputan"
                                ...
                                <option value="menunggu"
                                    {{ request('status_penjemputan') == 'menunggu' ? 'selected' : '' }}>Menunggu
                                </option>
                                <option value="diterima"
                                    {{ request('status_penjemputan') == 'diterima' ? 'selected' : '' }}>Diterima
                                    Amil</option>
                                <option value="dalam_perjalanan"
                                    {{ request('status_penjemputan') == 'dalam_perjalanan' ? 'selected' : '' }}>Dalam
                                    Perjalanan</option>
                                <option value="sampai_lokasi"
                                    {{ request('status_penjemputan') == 'sampai_lokasi' ? 'selected' : '' }}>Sampai
                                    Lokasi</option>
                                <option value="selesai"
                                    {{ request('status_penjemputan') == 'selesai' ? 'selected' : '' }}>Selesai
                                </option>
                            </select>
                        </div>
...
@push('scripts')
    <script>
        ...
        // Fungsi untuk update status penjemputan via AJAX
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('DOM Content Loaded - Transaksi Dijemput');
