                ...
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="space-y-1.5 text-xs text-gray-600">
                            @foreach([
                                ['waktu_request',       'Request',   'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
                                ['waktu_diterima_amil', 'Diterima',  'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
                                ['waktu_berangkat',     'Berangkat', 'M13 7l5 5m0 0l-5 5m5-5H6'],
                                ['waktu_sampai',        'Sampai',    'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z'],
                                ['waktu_selesai',       'Selesai',   'M5 13l4 4L19 7'],
                            ] as [$field, $label, $path])
                                @if($transaksi->$field)
