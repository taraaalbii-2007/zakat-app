...
<div class="space-y-4 sm:space-y-6">
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
        ...
        <form action="{{ route('superadmin.bulletin.update', $bulletin->uuid) }}" method="POST"
...
<form id="delete-thumbnail-form"
      action="{{ route('superadmin.bulletin.delete-thumbnail', $bulletin->uuid) }}"
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (quill) {
            ...
            if (text.length < 50) {
                ...
                submitBtn.innerHTML = '<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Perbarui Bulletin';
                return;
            }
        }
        form.submit();
