    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden transition-all duration-300">
           ...
           <!-- Header - DIPERBAIKI -->
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        ...
                        <button type="button" id="filterButton"
                            ...
                            {{ request()->hasAny(['search', 'status', 'tanggal', 'sumber', 'sort_by', 'sort_order']) ? 'bg-green-50' : '' }}">
            ...
            <div id="filterPanel" class="{{ request()->hasAny(['search', 'status', 'tanggal', 'sumber', 'sort_by', 'sort_order']) ? '' : 'hidden' }} px-5 py-3 border-b border-gray-100 bg-green-50/30">
                <form method="GET" action="{{ route('harga-emas-perak.index') }}" id="filter-form">
                    ...
                    <div class="flex gap-2 justify-end mt-4">
                        @if (request()->hasAny(['search', 'status', 'tanggal', 'sumber', 'sort_by', 'sort_order']))
            ...
            @if (request()->hasAny(['search', 'status', 'tanggal', 'sumber']))
