...
@section('content')
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            ...
            {{-- Filter Panel --}}
            <div id="filter-panel" class="{{ (request('status') || request('tanggal') || request('sumber') || request('sort_by')) ? '' : 'hidden' }} px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 border-b border-gray-200">
                            ...
                            <div class="flex items-center flex-wrap gap-2">
                                ...
                                @if(request('tanggal'))
                                    <span class="inline-flex items-center px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">
                                        ...
                                        <button type="button" onclick="removeFilter('tanggal')" class="ml-1.5 text-blue-600 hover:text-blue-800">
                                            ×
                                        </button>
                                    </span>
                                @endif
                                @if(request('sumber'))
                                    <span class="inline-flex items-center px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">
                                        ...
                                        <button type="button" onclick="removeFilter('sumber')" class="ml-1.5 text-blue-600 hover:text-blue-800">
                                            ×
                                        </button>
                                    </span>
                                @endif
                                        ...
                                        <div class="bg-gray-50 border-y border-gray-100">
                                            <div class="px-6 py-4">
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                        ...
                                                        <div class="space-y-3">
                                                            <div class="flex items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-sm font-medium text-gray-900">{{ $harga->tanggal->format('d F Y') }}</p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="flex items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-sm font-medium text-gray-900">{{ $harga->sumber ?? 'Tidak ada sumber' }}</p>
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="flex items-start">
                                                                <svg class="w-4 h-4 {{ $harga->is_active ? 'text-green-500' : 'text-gray-400' }} mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    {{-- Kolom 2: Harga --}}
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Detail Harga</h4>
                                                        <div class="space-y-3">
                                                            <div class="flex items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-sm font-medium text-gray-900">Rp {{ number_format($harga->harga_emas_pergram, 0, ',', '.') }}/gram</p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="flex items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-sm font-medium text-gray-900">Rp {{ number_format($harga->harga_perak_pergram, 0, ',', '.') }}/gram</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="flex items-center flex-1 min-w-0">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center mt-1">
                                                <span class="text-xs font-medium text-gray-700">Emas: Rp {{ number_format($harga->harga_emas_pergram, 0, ',', '.') }}</span>
                                                <span class="text-xs text-gray-500 mx-2">•</span>
                                                <span class="text-xs font-medium text-gray-700">Perak: Rp {{ number_format($harga->harga_perak_pergram, 0, ',', '.') }}</span>
                                            </div>
                                            @if($harga->sumber)
                                                <div class="text-xs text-gray-500 mt-1 truncate">Sumber: {{ $harga->sumber }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center text-sm">
                                                    ...
                                                    <span class="text-gray-900">Emas: Rp {{ number_format($harga->harga_emas_pergram, 0, ',', '.') }}/gram</span>
                                                </div>
                                                <div class="flex items-center text-sm">
                                                    <svg class="w-4 h-4 text-gray-400 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                    </svg>
                                                    <span class="text-gray-900">Perak: Rp {{ number_format($harga->harga_perak_pergram, 0, ',', '.') }}/gram</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if($harga->keterangan)
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">{{ Str::limit($harga->keterangan, 100) }}</p>
                                            </div>
                                        @endif
                                        ...
                                        <div class="pt-3 border-t border-gray-200">
                                            <div class="flex gap-2">
                                                ...
                                                <form action="{{ route('harga-emas-perak.toggle-status', $harga->uuid) }}" method="POST" class="flex-1">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit"
            ...
            @else
                <div class="p-8 sm:p-12 text-center">
                    ...
                    @else
                        ...
                        <p class="text-sm text-gray-500 mb-6">Mulai tambahkan data harga emas dan perak untuk sistem zakat.</p>
                        <a href="{{ route('harga-emas-perak.create') }}"
