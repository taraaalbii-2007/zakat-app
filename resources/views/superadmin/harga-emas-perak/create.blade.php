...
@section('title', 'Tambah Harga Emas & Perak')
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900">Tambah Harga Emas & Perak</h2>
                        <p class="text-xs sm:text-sm text-gray-500 mt-1">Tambahkan data harga emas dan perak per gram</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('harga-emas-perak.store') }}" method="POST" class="p-4 sm:p-6">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        {{-- Informasi Standard Harga --}}
                        <div class="mt-6 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                            <p class="text-xs text-blue-700 font-medium mb-1">Catatan Penting:</p>
                            <ul class="text-xs text-blue-600 space-y-1">
                                <li>• Harga emas dan perak mengacu pada harga murni (24 karat untuk emas)</li>
                                <li>• Pastikan data harga sudah valid sebelum disimpan</li>
                                <li>• Untuk nisab zakat maal, menggunakan harga emas 85 gram dan perak 595 gram</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="pb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Maksimal 500 karakter. Karakter tersisa: <span id="keterangan-counter">500</span></p>
                            @error('keterangan')
                                <p class="mt-1 text-xs sm:text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
