                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            ...
                            <select name="sort_by" id="filter-sort-by"
                                ...
                                <option value="nama" {{ request('sort_by', 'nama') === 'nama' ? 'selected' : '' }}>Nama
                                </option>
                                <option value="persentase_default"
                                    {{ request('sort_by') === 'persentase_default' ? 'selected' : '' }}>Persentase
                                </option>
                            ...
                            @foreach ($kategoriMustahik as $kategori)
                                ...
                                <tr class="hover:bg-gray-50 transition-colors cursor-pointer expandable-row"
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <span
                                            class="text-sm {{ $kategori->persentase_default !== null ? 'text-gray-900' : 'text-gray-400' }}">
                                ...
                                <tr id="detail-{{ $kategori->uuid }}" class="hidden expandable-content">
                                    <td colspan="4" class="px-0 py-0">
                                        <div class="bg-gray-50 border-y border-gray-100 px-6 py-4">
                                            ...
                                            <div
                                                class="mt-4 pt-4 border-t border-gray-200 text-xs text-gray-400 space-y-1">
                            ...
                            <div class="p-4 hover:bg-gray-50 transition-colors cursor-pointer expandable-row-mobile"
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex-1 min-w-0">
                                        <h3 class="text-sm font-semibold text-gray-900 truncate">{{ $kategori->nama }}
                                        </h3>
                                ...
                                <div class="bg-gray-50 px-4 py-3 border-t border-gray-100 space-y-3">
                                    @if ($kategori->kriteria)
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">{{ Str::limit($kategori->kriteria, 120) }}
                                            </p>
                                        </div>
                                    @endif
        ...
        document.addEventListener('click', function (e) {
            ...
            if (toggle) {
                ...
                requestAnimationFrame(() => {
                    // Batalkan jika uuid sudah berubah (user scroll/close cepat)
                    ...
                    // Jaga agar tidak keluar kiri/kanan viewport
                    if (left < margin) left = margin;
                    if (left + dropdownWidth > window.innerWidth - margin) {
                        left = window.innerWidth - dropdownWidth - margin;
                    }

                    // Jika tidak muat di bawah, tampilkan di atas tombol
                    if (rect.bottom + dropdownHeight > window.innerHeight) {
                        top = rect.top - dropdownHeight - 4;
                    }

                    // Jaga agar tidak keluar atas viewport
