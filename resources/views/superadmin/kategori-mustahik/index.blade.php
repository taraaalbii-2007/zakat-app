...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden transition-all duration-300">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        ...
                        <button type="button" id="filterButton"
                            ...
                            {{ request()->hasAny(['search', 'sort_by', 'sort_order']) ? 'bg-green-50' : '' }}">
            ...
            <div id="filterPanel" class="{{ request()->hasAny(['search', 'sort_by', 'sort_order']) ? '' : 'hidden' }} px-5 py-3 border-b border-gray-100 bg-green-50/30">
            ...
            @if (request()->hasAny(['search', 'sort_by', 'sort_order']) && (request('search') || (request('sort_by') && request('sort_by') != 'nama')))
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        @if (request('sort_by') && request('sort_by') != 'nama')
                            <div class="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-green-50 text-green-700 text-xs rounded-lg border border-green-200">
                                ...
                                <button onclick="removeFilter('sort_by'); removeFilter('sort_order')" class="hover:text-green-900 ml-1">×</button>
                            </div>
                        @endif
                    </div>
                </div>
