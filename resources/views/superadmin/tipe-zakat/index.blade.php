                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                        ...
                        <div>
                            ...
                            <select name="requires_haul" id="filter-haul"
                                ...
                                <option value="true" {{ request('requires_haul') == 'true' ? 'selected' : '' }}>Perlu
                                    Haul</option>
                                <option value="false" {{ request('requires_haul') == 'false' ? 'selected' : '' }}>Tanpa
                                    Haul</option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="sort_order" id="filter-sort-order"
                                ...
                                <option value="desc" {{ request('sort_order') == 'desc' ? 'selected' : '' }}>Menurun
                                    (Z-A)</option>
                            </select>
                        </div>
                    </div>
                                ...
                                @if (request('search'))
                                    <span
                                        ...
                                        <button type="button" onclick="removeFilter('search')"
                                            class="ml-1 text-blue-600 hover:text-blue-800 leading-none">×</button>
                                    </span>
                                @endif
                                @if (request('jenis_zakat_id'))
                                    ...
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 bg-blue-100 text-blue-800 text-xs rounded-full">
                                        {{ $jenis->nama ?? 'Unknown' }}
                                        <button type="button" onclick="removeFilter('jenis_zakat_id')"
                                            class="ml-1 text-blue-600 hover:text-blue-800 leading-none">×</button>
                                    </span>
                                @endif
                                @if (request('requires_haul'))
                                    <span
                                        ...
                                        <button type="button" onclick="removeFilter('requires_haul')"
                                            class="ml-1 text-blue-600 hover:text-blue-800 leading-none">×</button>
                                    </span>
                                @endif
                            </div>
                            ...
                            @foreach ($tipeZakat as $tipe)
                                <tr class="hover:bg-gray-50 transition-colors cursor-pointer expandable-row"
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500 mt-0.5">{{ $tipe->jenisZakat->nama ?? '-' }}
                                        </div>
                                        ...
                                        @if (!empty($nisabTypes))
                                            <div class="space-y-1">
                                                ...
                                                @if (count($nisabTypes) > 2)
                                                    <div class="text-xs text-gray-400">+{{ count($nisabTypes) - 2 }}
                                                        lainnya</div>
                                                @endif
                                            </div>
                                        @else
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($tipe->persentase_zakat)
                                            <div class="text-sm font-medium text-gray-900">
                                                {{ $tipe->formatted_persentase }}</div>
                                            @if ($tipe->persentase_alternatif)
                                                <div class="text-xs text-gray-500 mt-0.5">Alt:
                                                    {{ number_format($tipe->persentase_alternatif, 2) }}%</div>
                                            @endif
                                        @else
                                            <span class="text-xs text-gray-400">-</span>
                                        @endif
                                        ...
                                        <div class="bg-gray-50 border-y border-gray-100">
                                            <div class="px-6 py-4">
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Informasi Dasar
                                                        </h4>
                                                        <div class="space-y-3">
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Detail Nisab
                                                        </h4>
                                                        <div class="space-y-2">
                                                            @if ($tipe->nisab_emas_gram)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Emas:</span><span
                                                                        class="font-medium text-gray-900">{{ number_format($tipe->nisab_emas_gram, 2) }}
                                                                        gram</span></div>
                                                            @endif
                                                            @if ($tipe->nisab_perak_gram)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Perak:</span><span
                                                                        class="font-medium text-gray-900">{{ number_format($tipe->nisab_perak_gram, 2) }}
                                                                        gram</span></div>
                                                            @endif
                                                            @if ($tipe->nisab_pertanian_kg)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Pertanian:</span><span
                                                                        class="font-medium text-gray-900">{{ number_format($tipe->nisab_pertanian_kg, 2) }}
                                                                        kg</span></div>
                                                            @endif
                                                            @if ($tipe->nisab_kambing_min)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Kambing:</span><span
                                                                        class="font-medium text-gray-900">min
                                                                        {{ number_format($tipe->nisab_kambing_min) }}
                                                                        ekor</span></div>
                                                            @endif
                                                            @if ($tipe->nisab_sapi_min)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Sapi:</span><span
                                                                        class="font-medium text-gray-900">min
                                                                        {{ number_format($tipe->nisab_sapi_min) }}
                                                                        ekor</span></div>
                                                            @endif
                                                            @if ($tipe->nisab_unta_min)
                                                                <div class="flex justify-between text-sm"><span
                                                                        class="text-gray-600">Unta:</span><span
                                                                        class="font-medium text-gray-900">min
                                                                        {{ number_format($tipe->nisab_unta_min) }}
                                                                        ekor</span></div>
                                                            @endif
                                                            @if (
                                                                !$tipe->nisab_emas_gram &&
                                                                    !$tipe->nisab_perak_gram &&
                                                                    !$tipe->nisab_pertanian_kg &&
                                                                    !$tipe->nisab_kambing_min &&
                                                                    !$tipe->nisab_sapi_min &&
                                                                    !$tipe->nisab_unta_min)
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Ketentuan Zakat
                                                        </h4>
                                                        <div class="space-y-3">
                                                            <div class="flex items-start">
                                                                <svg class="w-4 h-4 text-gray-400 mt-0.5 mr-2 flex-shrink-0"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-sm font-medium text-gray-900">
                                                                        ...
                                                                        @if ($tipe->keterangan_persentase)
                                                                            <span
                                                                                class="text-xs text-gray-500 ml-1">({{ $tipe->keterangan_persentase }})</span>
                                                                        @endif
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        @if ($tipe->ketentuan_khusus)
                                                            <div class="mt-4 pt-4 border-t border-gray-200">
                                                                ...
                                                                <p class="text-sm text-gray-600">
                                                                    {{ Str::limit($tipe->ketentuan_khusus, 150) }}</p>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 mt-1.5">
                                            ...
                                            @if ($tipe->requires_haul)
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 bg-amber-50 text-amber-700 text-xs font-medium rounded-full border border-amber-100">
                                                    Haul
                                                </span>
                                            @endif
                                        </div>
                            ...
                            <div id="detail-mobile-{{ $tipe->uuid }}" class="hidden expandable-content-mobile">
                                <div class="bg-gray-50 px-4 py-3 border-t border-gray-100 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        @if ($hasNisab)
                                            <div
                                                class="bg-white rounded-lg border border-gray-100 divide-y divide-gray-50">
                                                @if ($tipe->nisab_emas_gram)
                                                ...
                                                @if ($tipe->nisab_kambing_min)
                                                    <div class="flex justify-between items-center px-3 py-2 text-sm">
                                                        ...
                                                        <span class="font-medium text-gray-900">min
                                                            {{ number_format($tipe->nisab_kambing_min) }} ekor</span>
                                                    </div>
                                                @endif
                                                @if ($tipe->nisab_sapi_min)
                                                    <div class="flex justify-between items-center px-3 py-2 text-sm">
                                                        ...
                                                        <span class="font-medium text-gray-900">min
                                                            {{ number_format($tipe->nisab_sapi_min) }} ekor</span>
                                                    </div>
                                                @endif
                                                @if ($tipe->nisab_unta_min)
                                                    <div class="flex justify-between items-center px-3 py-2 text-sm">
                                                        ...
                                                        <span class="font-medium text-gray-900">min
                                                            {{ number_format($tipe->nisab_unta_min) }} ekor</span>
                                                    </div>
                                                @endif
                                            </div>
                                        @else
                                            ...
                                            <div
                                                ...
                                                @if ($tipe->persentase_zakat)
                                                    <div class="flex justify-between items-center px-3 py-2 text-sm">
                                                        ...
                                                        <span
                                                            class="font-medium text-gray-900">{{ $tipe->formatted_persentase }}</span>
                                                    </div>
                                                @endif
                                                @if ($tipe->persentase_alternatif)
                                                    <div class="flex justify-between items-center px-3 py-2 text-sm">
                                                        ...
                                                        <span
                                                            class="font-medium text-gray-900">{{ number_format($tipe->persentase_alternatif, 2) }}%</span>
                                                    </div>
                                                @endif
                                                @if ($tipe->keterangan_persentase)
                                    ...
                                    @if ($tipe->ketentuan_khusus)
                                        <div>
                                            <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                                                Ketentuan Khusus</h4>
                                            <p
                                                class="text-sm text-gray-600 bg-white rounded-lg border border-gray-100 px-3 py-2">
            ...
            @else
                <div class="p-8 sm:p-12 text-center">
                    ...
                    @if (request('search') || request('jenis_zakat_id') || request('requires_haul'))
                        ...
                        <p class="text-sm text-gray-500 mb-6">Tidak ada data tipe zakat yang cocok dengan filter yang
                            dipilih.</p>
    ...
    <div id="delete-modal"
        ...
        <div class="p-4 sm:p-6 border border-gray-200 w-full max-w-sm shadow-lg rounded-xl sm:rounded-2xl bg-white">
            ...
            <p class="text-xs sm:text-sm text-gray-500 mb-1 text-center">
                Apakah Anda yakin ingin menghapus tipe zakat "<span id="modal-nama"
