                                ...
                                <div class="flex items-center">
                                    <div class="relative flex-1">
                                        ...
                                        <input type="search" name="search" value="{{ request('search') }}"
                                            id="search-input" placeholder="Cari nama tipe atau ketentuan..."
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <select name="requires_haul" id="filter-haul"
                                ...
                                <option value="true" {{ request('requires_haul') == 'true' ? 'selected' : '' }}>
                                    Memerlukan Haul</option>
                                    ...
                                    <div class="flex items-center flex-1 min-w-0">
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between">
                                                ...
                                                @if ($tipe->requires_haul)
                                                    <span class="text-xs text-gray-500 flex-shrink-0">Haul</span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="flex items-center mt-1">
                                                @if ($tipe->persentase_zakat)
                                                    <span
                                                        class="text-xs font-medium text-gray-700">{{ $tipe->formatted_persentase }}</span>
                                                    @if ($tipe->persentase_alternatif)
                                                        <span class="text-xs text-gray-500 ml-1">(Alt:
                                                            {{ number_format($tipe->persentase_alternatif, 0) }}%)</span>
                                                    @endif
                                                @else
                                                    <span class="text-xs text-gray-400">-</span>
                                                @endif
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        @if ($tipe->ketentuan_khusus)
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">
                                                    {{ Str::limit($tipe->ketentuan_khusus, 100) }}</p>
                                            </div>
                                        @endif
