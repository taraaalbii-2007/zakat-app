...
<div class="space-y-4 sm:space-y-6">
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
        ...
        <form action="{{ route('pengguna.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
            @csrf
            ...
            <div id="section-admin-masjid" class="{{ old('peran') === 'admin_masjid' ? '' : 'hidden' }} mb-6 sm:mb-8">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div>
                        <label for="admin_foto" class="block text-sm font-medium text-gray-700 mb-2">Foto Admin <span class="text-gray-400 text-xs font-normal">(opsional, maks 2MB)</span></label>
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_masjid" id="deskripsi_masjid" rows="2"
                            ...
                            class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 resize-none transition-all @error('deskripsi_masjid') border-red-500 @enderror">{{ old('deskripsi_masjid') }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4 mb-6">
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" rows="2"
                            ...
                            class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 resize-none transition-all @error('alamat') border-red-500 @enderror">{{ old('alamat') }}</textarea>
                        ...
                        <div>
                            ...
                            <select name="provinsi_kode" id="provinsi_kode"
                                ...
                                @foreach($provinces as $prov)
                                    <option value="{{ $prov->code }}" {{ old('provinsi_kode') === $prov->code ? 'selected' : '' }}>
                                        {{ $prov->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="kapasitas_jamaah" id="kapasitas_jamaah" value="{{ old('kapasitas_jamaah') }}"
            ...
            {{-- ════════════════════════════════════════════════════════ --}}
            <div id="section-amil" class="{{ old('peran') === 'amil' ? '' : 'hidden' }} mb-6 sm:mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="amil_nama_lengkap" id="amil_nama_lengkap" value="{{ old('amil_nama_lengkap') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="amil_jenis_kelamin" id="amil_jenis_kelamin"
                                ...
                                <option value="L" {{ old('amil_jenis_kelamin') === 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('amil_jenis_kelamin') === 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="amil_tempat_lahir" id="amil_tempat_lahir" value="{{ old('amil_tempat_lahir') }}"
                                placeholder="Jakarta"
                        ...
                        <div>
                            ...
                            <input type="date" name="amil_tanggal_lahir" id="amil_tanggal_lahir"
                                value="{{ old('amil_tanggal_lahir') }}" max="{{ date('Y-m-d') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="amil_telepon" id="amil_telepon" value="{{ old('amil_telepon') }}"
                                placeholder="08xxxxxxxxxx"
                        ...
                        <div>
                            ...
                            <select name="amil_status" id="amil_status"
                                ...
                                <option value="aktif"    {{ old('amil_status', 'aktif') === 'aktif'    ? 'selected' : '' }}>Aktif</option>
                                <option value="nonaktif" {{ old('amil_status') === 'nonaktif' ? 'selected' : '' }}>Non-Aktif</option>
                                <option value="cuti"     {{ old('amil_status') === 'cuti'     ? 'selected' : '' }}>Cuti</option>
                            </select>
                    ...
                    <div>
                        ...
                        <textarea name="amil_alamat" id="amil_alamat" rows="2"
                            ...
                            class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-500 resize-none transition-all @error('amil_alamat') border-red-500 @enderror">{{ old('amil_alamat') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="amil_tanggal_mulai_tugas" id="amil_tanggal_mulai_tugas"
                                value="{{ old('amil_tanggal_mulai_tugas', date('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="amil_tanggal_selesai_tugas" id="amil_tanggal_selesai_tugas"
                                value="{{ old('amil_tanggal_selesai_tugas') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="amil_wilayah_tugas" id="amil_wilayah_tugas" value="{{ old('amil_wilayah_tugas') }}"
                    ...
                    <div>
                        <label for="amil_foto" class="block text-sm font-medium text-gray-700 mb-2">Foto Amil <span class="text-gray-400 text-xs font-normal">(opsional, maks 2MB)</span></label>
                    ...
                    <div>
                        ...
                        <textarea name="amil_keterangan" id="amil_keterangan" rows="2"
                            ...
                            class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-500 resize-none transition-all">{{ old('amil_keterangan') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 sm:mb-8">
                <h3 class="flex items-center gap-2 text-sm sm:text-base font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">
                    <span id="status-step-num" class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-xs">
                        {{ in_array(old('peran'), ['admin_masjid','amil']) ? '4' : '3' }}
                    </span>
                    Status Akun
                </h3>
...
document.addEventListener('DOMContentLoaded', function () {
    const oldPeran = '{{ old('peran', '') }}';
    if (oldPeran) handlePeranChange(oldPeran);

    // Reload wilayah jika ada old value setelah validasi error
    const oldProvinsi = '{{ old('provinsi_kode', '') }}';
    if (oldProvinsi) {
        loadKota(oldProvinsi, '{{ old('kota_kode', '') }}');
    }
});
