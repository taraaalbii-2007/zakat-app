                    ...
                    <div class="flex flex-col sm:flex-row items-start gap-4">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex flex-wrap gap-2 mt-3">
                                ...
                                @endphp
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $peranColor }}">
                                    {{ $peranLabel }}
                                </span>
                ...
                <div class="mt-6">
                    ...
                    <div id="content-info" class="tab-content mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-sm font-medium text-gray-900">{{ $pengguna->username ?? '-' }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-0.5">
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {{ $peranColor }}">
                                                    {{ $peranLabel }}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">
                                                    {{ $pengguna->masjid?->nama ?? '-' }}</p>
                                                @if ($pengguna->masjid)
                                                    <p class="text-xs text-gray-400 mt-0.5">
                                                        {{ $pengguna->masjid->kode_masjid }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
                            ...
                            {{-- Kolom kanan --}}
                            <div class="space-y-4">
                                <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Status & Aktivitas
                                </h4>
                                <div class="space-y-3">

                                    {{-- Status Akun --}}
                                    <div
                                        class="p-4 rounded-xl border {{ $pengguna->is_active ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200' }}">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p
                                                    class="text-xs {{ $pengguna->is_active ? 'text-green-700' : 'text-red-700' }} font-medium">
                                                    Status Akun</p>
                                                <p
                                                    class="text-sm font-bold {{ $pengguna->is_active ? 'text-green-900' : 'text-red-900' }} mt-0.5">
                                                    {{ $pengguna->is_active ? 'Aktif' : 'Nonaktif' }}
                                                </p>
                                            </div>
                                            <div
                                                class="w-10 h-10 rounded-full {{ $pengguna->is_active ? 'bg-green-200' : 'bg-red-200' }} flex items-center justify-center">
                                                @if ($pengguna->is_active)
                    ...
                    @if ($pengguna->peran === 'admin_masjid' && $pengguna->masjid)
                        <div id="content-masjid" class="tab-content hidden mt-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Informasi
                                        Masjid</h4>
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            <div
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">{{ $pengguna->masjid->nama }}
                                                </p>
                                                <p class="text-xs text-gray-400 mt-0.5">
                                                    {{ $pengguna->masjid->kode_masjid }}</p>
                                            </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">
                                                    {{ $pengguna->masjid->alamat }}</p>
                                                <p class="text-xs text-gray-400 mt-0.5">
                                                    {{ $pengguna->masjid->kelurahan_nama }},
                                                    {{ $pengguna->masjid->kecamatan_nama }},
                                                    {{ $pengguna->masjid->kota_nama }},
                                                    {{ $pengguna->masjid->provinsi_nama }}
                                        ...
                                        @if ($pengguna->masjid->deskripsi)
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    ...
                                                    <p class="text-sm text-gray-900">{{ $pengguna->masjid->deskripsi }}
                                                    </p>
                                                </div>
                                            </div>
                                        @endif
                                ...
                                {{-- Data Tambahan --}}
                                <div class="space-y-4">
                                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Data Tambahan
                                    </h4>
                                    <div class="space-y-3">
                                        @if ($pengguna->masjid->tahun_berdiri)
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    ...
                                                    <p class="text-sm font-medium text-gray-900">
                                                        {{ $pengguna->masjid->tahun_berdiri }}</p>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if ($pengguna->masjid->kapasitas_jamaah)
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    ...
                                                    <p class="text-sm font-medium text-gray-900">
                                                        {{ number_format($pengguna->masjid->kapasitas_jamaah) }} orang</p>
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    {{-- Admin Masjid Info --}}
                                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mt-6">Admin
                                        Masjid</h4>
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                <p class="text-xs text-gray-500">Telepon / Email</p>
                                                <p class="text-sm font-medium text-gray-900">
                                                    {{ $pengguna->masjid->admin_telepon }}</p>
                                                <p class="text-xs text-gray-400 mt-0.5">
                                                    {{ $pengguna->masjid->admin_email }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if ($pengguna->peran === 'amil' && $pengguna->amil)
                        <div id="content-amil" class="tab-content hidden mt-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                {{-- Data Pribadi --}}
                                <div class="space-y-4">
                                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Data Pribadi
                                    </h4>
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">
                                                    {{ $pengguna->amil->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">
                                                    {{ $pengguna->amil->tempat_lahir }},
                                                    {{ \Carbon\Carbon::parse($pengguna->amil->tanggal_lahir)->format('d M Y') }}
                                                </p>
                                                <p class="text-xs text-gray-400 mt-0.5">
                                                    Usia: {{ \Carbon\Carbon::parse($pengguna->amil->tanggal_lahir)->age }}
                                                    tahun
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                <p class="text-xs text-gray-500">Alamat</p>
                                                <p class="text-sm font-medium text-gray-900">{{ $pengguna->amil->alamat }}
                                                </p>
                                            </div>
                                        </div>
                                ...
                                {{-- Data Tugas --}}
                                <div class="space-y-4">
                                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Data Tugas
                                    </h4>
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">
                                                    Mulai:
                                                    {{ \Carbon\Carbon::parse($pengguna->amil->tanggal_mulai_tugas)->format('d M Y') }}
                                                </p>
                                                @if ($pengguna->amil->tanggal_selesai_tugas)
                                                    <p class="text-xs text-gray-400 mt-0.5">
                                                        Selesai:
                                                        {{ \Carbon\Carbon::parse($pengguna->amil->tanggal_selesai_tugas)->format('d M Y') }}
                                                    </p>
                                                @else
                    ...
                    <div id="content-keamanan" class="tab-content hidden mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-5">
                                ...
                                <p class="text-xs text-gray-500 mb-4">Set password baru untuk pengguna ini secara manual.
                                </p>
    ...
    <div id="delete-modal"
        ...
        <div class="p-4 sm:p-6 border border-gray-200 w-full max-w-sm shadow-lg rounded-xl sm:rounded-2xl bg-white">
            ...
            <p class="text-xs sm:text-sm text-gray-500 mb-1 text-center">
                Hapus akun "<span
                    class="font-semibold text-gray-700">{{ $pengguna->username ?? $pengguna->email }}</span>"?
            </p>
