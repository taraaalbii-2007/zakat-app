...
@section('auth-content')
    ...
    <form method="POST" action="{{ route('password.update', $uuid) }}" id="resetForm" novalidate>
        ...
        <div class="lg-group">
            ...
            <div class="lg-wrap {{ $errors->has('password') ? 'err' : '' }}">
                ...
                <input type="password" id="password" name="password"
                    ...
                    placeholder="Masukkan password baru" autocomplete="new-password" autofocus required
        ...
        {{-- ── Submit ── --}}
        <button type="button" class="btn-masuk" id="submitBtn" onclick="handleSubmit()" disabled aria-disabled="true">
        ...
        (function () {
            ...
            function updateMatch() {
                ...
                matchHint.querySelector('svg').innerHTML = ok
                    ? `<path fill-rule="evenodd" fill="currentColor" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>`
            ...
            [pwInput, confInput].forEach(function (el) {
            ...
            window.handleSubmit = async function () {
                ...
                try {
                    ...
                    if (siteKey) {
                        ...
                        const token = await grecaptcha.execute(siteKey, { action: 'reset_password' });
