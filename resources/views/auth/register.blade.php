...
@section('content')
    <form method="POST" action="{{ route('register') }}" class="space-y-6" id="register-form">
        ...
        <!-- Tambahkan ini SEBELUM Email Field -->
        <div class="space-y-3 mb-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <label class="relative cursor-pointer">
                    <input type="radio" name="role" value="admin_masjid" class="peer sr-only" checked>
                    <div
                        class="flex flex-col items-center p-4 border-2 border-neutral-200 rounded-xl 
                        peer-checked:border-primary peer-checked:bg-primary-50 
                        hover:border-neutral-300 transition-all duration-200">
                        <svg class="w-8 h-8 mb-2 text-neutral-400 peer-checked:text-primary" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        <span class="text-xs font-semibold text-neutral-600 text-center">Admin Masjid</span>
                        <span class="text-xs text-neutral-400 text-center mt-1">Kelola zakat masjid</span>
                    </div>
                </label>

                <!-- Card Muzakki -->
                <label class="relative cursor-pointer">
                    <input type="radio" name="role" value="muzakki" class="peer sr-only">
                    <div
                        class="flex flex-col items-center p-4 border-2 border-neutral-200 rounded-xl 
                        peer-checked:border-primary peer-checked:bg-primary-50 
                        hover:border-neutral-300 transition-all duration-200">
                        ...
                        <span class="text-xs font-semibold text-neutral-600 text-center">Muzakki</span>
                        <span class="text-xs text-neutral-400 text-center mt-1">Bayar & pantau zakat</span>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="space-y-2">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-neutral-400 group-focus-within:text-primary transition-colors" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
...
@section('footer-links')
    <p class="text-white text-sm">
        Sudah punya akun?
        <a href="{{ route('login') }}"
            class="font-semibold text-primary-100 hover:text-white transition-colors underline underline-offset-2">
            Masuk di sini
        </a>
    </p>
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        // ← TAMBAH DI SINI — Update href Google button saat role berubah
