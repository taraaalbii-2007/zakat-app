                            ...
                            <li>
                                <a href="{{ route('superadmin.bulletin.index') }}"
                                    ...
                                    @if(!empty($bulletinPendingCount) && $bulletinPendingCount > 0)
                                        <span class="inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold rounded-full bg-amber-400 text-white leading-none">
                ...
                <li>
                    <a href="{{ route('superadmin.testimoni.index') }}"
                        ...
                        @if($pendingTestimoniCount > 0)
                            <span class="ml-auto inline-flex items-center justify-center w-5 h-5 text-xs font-bold bg-amber-400 text-white rounded-full">
            ...
            @if ($isAdminLembaga)
                ...
                <li>
                    <a href="{{ route('admin-lembaga.bulletin.index') }}"
                        ...
                        @if(str_contains($currentRoute, 'admin-lembaga.bulletin') || str_contains($currentRoute, 'bulletin-saya'))
