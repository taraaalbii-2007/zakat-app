            ...
            @if ($isSuperadmin)
                ...
                <li>
                    <a href="{{ route('dashboard') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'dashboard') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('pengguna.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'pengguna') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <details class="group" {{ str_contains($currentRoute, 'bulletin') || str_contains($currentRoute, 'kategori-bulletin') ? 'open' : '' }}>
                        <summary class="{{ $summaryClass }} text-[13px]">
                            <svg class="w-4 h-4 flex-shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('masjid.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'masjid') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('superadmin.amil.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'amil') && !str_contains($currentRoute, 'profil') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('superadmin.mustahik.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'mustahik') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('muzaki.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'muzaki') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('laporan-konsolidasi.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'laporan-konsolidasi') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('log-aktivitas.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'log-aktivitas') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('konfigurasi-global.show') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'konfigurasi-global') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @if ($isAdminMasjid)
                ...
                <li>
                    <a href="{{ route('amil.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'amil') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <span>Data Amil</span>
                ...
                <li>
                    <a href="{{ route('admin-masjid.muzaki.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'admin-masjid.muzaki') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('transaksi-penyaluran.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'transaksi-penyaluran') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('admin-masjid.setor-kas.pending') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'setor-kas') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('laporan-keuangan.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'laporan-keuangan') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span>Keuangan</span>
                ...
                <li>
                    <a href="{{ route('konfigurasi-integrasi.show') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'konfigurasi-integrasi') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
            ...
            @if ($isAmil)
                ...
                <li>
                    <a href="{{ route('amil.kunjungan.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'kunjungan') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
            ...
            @if (auth()->user() && auth()->user()->peran === 'muzakki')
                ...
                <li>
                    <a href="{{ route('transaksi-daring-muzakki.index') }}"
                        ...
                        <svg class="w-4 h-4 flex-shrink-0 {{ str_contains($currentRoute, 'transaksi-penerimaan') ? 'text-[#17a34a]' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
