{{-- resources/views/amil/partials/header.blade.php --}}
{{-- Letakkan di dalam layouts/blade.php --}}
            ...
            <div class="flex items-center space-x-3">
                            ...
                            <a href="#" class="block p-4 hover:bg-neutral-50 border-b border-neutral-100 transition-colors">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-neutral-600 mt-0.5">Anda menerima zakat dari muzakki</p>
                ...
                <div class="relative">
                    <button onclick="toggleUserMenu()"
                        ...
                        {{-- Avatar: foto amil atau initial --}}
                        @php $amil = auth()->user()?->amil; @endphp
                        <div class="w-8 h-8 rounded-full overflow-hidden bg-emerald-700 flex items-center justify-center flex-shrink-0">
                            @if($amil && $amil->foto)
                                <img src="{{ $amil->foto_url }}" alt="{{ $amil->nama_lengkap }}" class="w-full h-full object-cover">
                            @else
                        ...
                        <div class="hidden lg:block text-left">
                            <p class="text-sm font-medium text-neutral-900 leading-tight">
                                {{ $amil?->nama_lengkap ?? auth()->user()->username ?? 'Amil' }}
                            </p>
                            <p class="text-xs text-neutral-500">Amil</p>
                        </div>
                    ...
                    <div id="user-menu-dropdown"
                         class="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-modal border border-neutral-200 hidden animate-scale-in">
                        ...
                        {{-- Menu items --}}
                        <div class="py-2">
                            {{-- Profil Saya ← link ke halaman profil amil --}}
