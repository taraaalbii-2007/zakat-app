...
<style>
    ...
    /* ── KONSISTENSI TINGGI SLIDE & CARD ── */
    .fiturSwiper .swiper-slide {
        height: auto;
        display: flex;
    }

    .fiturSwiper .swiper-wrapper {
        align-items: stretch;
    }

    .fiturSwiper .swiper-slide .feature-card {
        min-height: 340px;
        height: 100%;
        width: 100%;
    }
                ...
                <div class="swiper-wrapper">
                    @php
                        $features = [
                            [
                                ...
                                'Daftarkan, kelola status, dan pantau kinerja amil per lembaga lengkap dengan kode unik, wilayah tugas, dan laporan transaksi masing-masing.',
                                'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
                            ],
                            [
                                '02',
                                'Transaksi Zakat Multi-Mode',
                                'Muzakki dapat membayar zakat secara langsung, dijemput amil, maupun daring — lengkap dengan hitung otomatis nisab, fidyah, dan zakat mal.',
                                'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z',
                            ],
                            [
                                '03',
                                'Laporan Keuangan Transparan',
                                'Generate laporan bulanan & tahunan secara otomatis, lengkap dengan grafik penerimaan & penyaluran, serta ekspor PDF yang dapat dipublikasikan.',
                                'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
                            ],
                            [
                                '04',
                                'Mustahik Terverifikasi',
                                'Setiap penerima zakat melalui proses verifikasi ketat dengan pencatatan NIK, kategori, dan riwayat kunjungan amil langsung di lapangan.',
                                'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
                            ],
                            [
                                '05',
                                'Kas Harian & Setor Kas Amil',
                                'Amil mencatat kas harian secara digital — buka, tutup, dan setor kas ke lembaga dengan rekap otomatis, tanda tangan digital, dan riwayat lengkap.',
                                'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z',
                            ],
                            [
                                '06',
                                'Integrasi QRIS & Multi-Rekening',
                                'Dukung pembayaran via QRIS dan atur rekening lembaga secara fleksibel — tetapkan rekening utama, aktifkan/nonaktifkan, dan kelola multi-rekening dalam satu dasbor.',
                    ...
                    @foreach ($features as $f)
                        <div class="swiper-slide h-auto">
                            <div class="feature-card p-8 flex flex-col justify-between">
