...
<style>
    ...
    #mobileMenuBtn.is-open .hamburger-bar:nth-child(1) { transform: translateY(7px) rotate(45deg); }
    #mobileMenuBtn.is-open .hamburger-bar:nth-child(2) { opacity: 0; transform: scaleX(0); }
    #mobileMenuBtn.is-open .hamburger-bar:nth-child(3) { transform: translateY(-7px) rotate(-45deg); }
</style>
    ...
    <div class="w-full px-4 sm:px-10 lg:px-20">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <a href="/" class="flex items-center group flex-shrink-0">
                <img
                    src="{{ asset('image/logo_zakat.png') }}"
            ...
            <div class="hidden lg:flex items-center gap-0.5">
                ...
                <div class="nav-dropdown-wrap relative" data-nav-group="panduan">
                    <button
                        data-nav="panduan"
                        class="nav-link-item nav-link flex items-center gap-1">
                        Panduan
                        <svg class="nav-chevron w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    ...
                    <div class="nav-dropdown">
                        <a href="{{ route('panduan-zakat') }}" data-nav="panduan-zakat" class="nav-link">
                            <svg class="w-4 h-4 opacity-50 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="p-2 flex flex-col gap-0.5">
                ...
                <div>
                    <button id="panduan-toggle"
                        ...
                        <span>Panduan</span>
                        <svg id="panduan-arrow" class="w-4 h-4 opacity-40 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
