    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-white">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-gray-500 mt-1">Informasi lengkap tentang lembaga</p>
                    </div>
            ...
            <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="carousel-container relative bg-gray-100 rounded-xl overflow-hidden border border-gray-200">
                            ...
                            <div class="absolute top-4 right-4 bg-black bg-opacity-50 text-white text-xs px-2 py-1 rounded-lg z-10">
                                <span id="current-slide">1</span>/<span id="total-slides">{{ count($lembaga->foto) }}</span>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                {{-- Data Sejarah --}}
                <div>
                    <h4 class="text-sm sm:text-base font-semibold text-gray-900 mb-4">Data Sejarah Lembaga</h4>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                    ...
                                    <div class="flex items-center text-sm text-gray-900">
                                        ...
                                        @if($lembaga->usia_lembaga)
                                            <span class="ml-2 text-xs text-gray-500">({{ $lembaga->usia_lembaga }} tahun)</span>
                                        @endif
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                    ...
                                    <div class="flex items-center text-sm text-gray-900">
                                        ...
                                        {{ number_format($lembaga->kapasitas_jamaah, 0, ',', '.') }} orang
                                    </div>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                    ...
                                    <div class="flex items-start text-sm text-gray-900">
                                        ...
                                        <span>{{ $lembaga->alamat_lengkap }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <span class="text-gray-900 font-medium">{{ $lembaga->provinsi_nama }}</span>
                                    </div>
                                    @endif
                                    
                                    @if($lembaga->kota_nama)
                                    <div class="flex items-center text-sm">
                                        <span class="text-gray-500 w-24 flex-shrink-0">Kota/Kab:</span>
                                        <span class="text-gray-900 font-medium">{{ $lembaga->kota_nama }}</span>
                                    </div>
                                    @endif
                                    
                                    @if($lembaga->kecamatan_nama)
                                    <div class="flex items-center text-sm">
                                        <span class="text-gray-500 w-24 flex-shrink-0">Kecamatan:</span>
                                        <span class="text-gray-900 font-medium">{{ $lembaga->kecamatan_nama }}</span>
                                    </div>
                                    @endif
                                    
                                    @if($lembaga->kelurahan_nama)
                                    <div class="flex items-center text-sm">
                                        <span class="text-gray-500 w-24 flex-shrink-0">Kelurahan:</span>
                                        <span class="text-gray-900 font-medium">{{ $lembaga->kelurahan_nama }}</span>
                                    </div>
                                    @endif
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <span class="text-gray-900 font-medium">{{ $lembaga->kode_pos }}</span>
                                    </div>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="text-xs text-gray-500 pt-4 border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row flex-wrap gap-4">
                        <div class="flex items-center">
                            ...
                            Dibuat: {{ $lembaga->created_at->translatedFormat('d F Y H:i') }}
                        </div>
                        <div class="flex items-center">
                            <svg class="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                            Diperbarui: {{ $lembaga->updated_at->translatedFormat('d F Y H:i') }}
                        </div>
                    </div>
                </div>
    ...
    <div id="delete-modal"
        ...
        <div class="p-6 border border-gray-200 w-full max-w-sm shadow-lg rounded-xl bg-white">
            ...
            <p class="text-sm text-gray-500 mb-1 text-center">
                ...
                "<span class="font-semibold text-gray-700">{{ $lembaga->nama }}</span>"?
            </p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentSlide = 0;
        let slideInterval;
        const totalSlides = {{ $lembaga->foto ? count($lembaga->foto) : 0 }};
