        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            ...
            <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 h-full">
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Lembaga Penempatan</label>
                            <div class="flex items-start text-sm text-gray-900">
                                <svg class="w-4 h-4 mr-2 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                <div>
                                    <div class="font-medium">{{ $amil->lembaga->nama }}</div>
                                    <div class="text-xs text-gray-500">{{ $amil->lembaga->kode_lembaga }}</div>
                                    @if($amil->lembaga->alamat)
                                        <div class="text-xs text-gray-600 mt-1">{{ $amil->lembaga->alamat }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
