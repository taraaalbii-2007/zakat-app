                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div>
                                ...
                                <select name="lembaga_id" id="lembaga_id" required
                                    class="block w-full px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary @error('lembaga_id') border-red-500 @enderror">
                        ...
                        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-blue-700">
                                    Data amil akan didaftarkan untuk lembaga: 
                                    <strong>{{ auth()->user()->lembaga->nama ?? 'Lembaga Anda' }}</strong>
                                </p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    @if(auth()->user()->lembaga && auth()->user()->lembaga->foto_count > 0)
                                        <a href="{{ auth()->user()->lembaga->foto_urls[0] }}" target="_blank" 
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (userRole === 'superadmin') {
                ...
                if (lembagaSelect && !lembagaSelect.value) {
                    alert('❌ Silakan pilih lembaga terlebih dahulu.');
                    lembagaSelect.focus();
                    event.preventDefault();
                    return;
                }
