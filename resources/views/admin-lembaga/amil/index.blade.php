...
@section('content')
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
                                ...
                                <div class="flex items-center">
                                    <div class="relative flex-1">
                                        ...
                                        <input type="search" name="search" value="{{ request('search') }}"
                                            id="search-input" placeholder="Cari amil..."
            ...
            {{-- Filter Panel --}}
            <div id="filter-panel"
                class="{{ request('status') || request('masjid_id') || request('jenis_kelamin') || request('sort_by') ? '' : 'hidden' }} px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 border-b border-gray-200">
                                ...
                                <select name="masjid_id" id="filter-masjid"
                                    ...
                                    @foreach ($masjids as $masjid)
                                        <option value="{{ $masjid->id }}"
                                            {{ request('masjid_id') == $masjid->id ? 'selected' : '' }}>
                                            {{ $masjid->nama }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            ...
                            <select name="sort_by" id="filter-sort-by"
                                ...
                                <option value="nama_lengkap" {{ request('sort_by') == 'nama_lengkap' ? 'selected' : '' }}>
                                    Nama</option>
                                <option value="kode_amil" {{ request('sort_by') == 'kode_amil' ? 'selected' : '' }}>Kode
                                </option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center flex-wrap gap-2">
                                ...
                                @if (request('masjid_id'))
                                    <span
                                        ...
                                        <button type="button" onclick="removeFilter('masjid_id')"
                                            class="ml-1.5 text-blue-600 hover:text-blue-800">
                                            ×
                                        </button>
                                    </span>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                ...
                                                @else
                                                    {{-- Jika tidak ada foto, tampilkan avatar dengan inisial --}}
                                                    @php
                                                        $colors = [
                                                            'bg-blue-500',
                                                            'bg-green-500',
                                        ...
                                        <div class="bg-gray-50 border-y border-gray-100">
                                            <div class="px-6 py-4">
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Data Pribadi
                                                        </h4>
                                                        <div class="space-y-3">
                                                            ...
                                                            <div class="flex items-start">
                                                                ...
                                                                <div>
                                                                    <p class="text-xs text-gray-500">Tempat, Tanggal Lahir
                                                                    </p>
                                                                    <p class="text-sm font-medium text-gray-900">
                                                                        {{ $amil->tempat_lahir }},
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Kontak & Alamat
                                                        </h4>
                                                        <div class="space-y-3">
                                                            <div class="flex items-start">
                                                                <svg class="w-4 h-4 text-gray-400 mt-0.5 mr-2 flex-shrink-0"
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-medium text-gray-900 mb-3">Status & Info
                                                        </h4>
                                                        <div class="space-y-3">
                                                            <div class="flex items-start">
                                                                <svg class="w-4 h-4 text-gray-400 mt-0.5 mr-2 flex-shrink-0"
                                                        ...
                                                        <div class="mt-4 pt-4 border-t border-gray-200">
                                                            <div class="text-xs text-gray-500 space-y-1">
                                                                <div>Bergabung: {{ $amil->created_at->format('d/m/Y') }}
                                                                </div>
                                                                @if ($amil->updated_at != $amil->created_at)
                                                                    <div>Diperbarui:
                                                                        {{ $amil->updated_at->format('d/m/Y H:i') }}</div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="flex items-center flex-1 min-w-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between">
                                                ...
                                                @else
                                                    <span
                                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-800 flex-shrink-0">
                                                        P
                                                    </span>
                                                @endif
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex items-center text-sm">
                                                    ...
                                                    <span class="text-gray-900">{{ $amil->tempat_lahir }},
                                                        {{ $amil->tanggal_lahir->translatedFormat('d M Y') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                @if ($amil->wilayah_tugas)
                                                    <div class="flex items-center text-xs">
                                                        ...
                                                        <span class="text-gray-700">Wilayah:
                                                            {{ $amil->wilayah_tugas }}</span>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
