    ...
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-white from-primary/5 to-primary/10">
                <h2 class="text-base sm:text-lg font-semibold text-gray-900">Form Tambah Mustahik</h2>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Isi field yang diperlukan untuk menambahkan data mustahik
                </p>
            </div>
            <form action="{{ route('mustahik.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
                @csrf
                ...
                <div class="mb-6 sm:mb-8">
                    <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-xs mr-2">1</span>
                        Data Pribadi
                    </h3>
                    <div class="space-y-4 sm:space-y-6">
                        {{-- NIK & KK --}}
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="kk" id="kk" value="{{ old('kk') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}"
                                placeholder="Masukkan nama lengkap" maxlength="255"
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label
                                    class="relative flex items-center justify-center p-4 border-2 border-gray-200 rounded-xl cursor-pointer transition-all hover:border-primary/50 has-[:checked]:border-primary has-[:checked]:bg-primary/5">
                                    <input type="radio" name="jenis_kelamin" value="L"
                                        {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }} class="sr-only peer">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 text-blue-600 peer-checked:bg-primary peer-checked:text-white transition-all">
                                    ...
                                    <div
                                        class="absolute top-3 right-3 w-5 h-5 rounded-full border-2 border-gray-300 peer-checked:border-primary peer-checked:bg-primary flex items-center justify-center transition-all">
                                        <svg class="w-3 h-3 text-white hidden peer-checked:block" fill="currentColor"
                                            viewBox="0 0 20 20">
                                ...
                                <label
                                    ...
                                    <input type="radio" name="jenis_kelamin" value="P"
                                        {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }} class="sr-only peer">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 rounded-full bg-pink-100 text-pink-600 peer-checked:bg-primary peer-checked:text-white transition-all">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                            </svg>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="text" name="tempat_lahir" id="tempat_lahir"
                                    value="{{ old('tempat_lahir') }}" placeholder="Kota kelahiran" maxlength="255"
                ...
                <div class="mb-6 sm:mb-8">
                    <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-xs mr-2">2</span>
                        Alamat
                    </h3>
                    <div class="space-y-4 sm:space-y-6">
                        {{-- Alamat Lengkap --}}
                        <div>
                            ...
                            <textarea name="alamat" id="alamat" rows="3" placeholder="Masukkan alamat lengkap"
                                class="block w-full px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('alamat') border-red-500 @enderror">{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <p class="mt-1 text-xs sm:text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="text" name="rt_rw" id="rt_rw" value="{{ old('rt_rw') }}"
                                    placeholder="001/002" maxlength="10"
                ...
                <div class="mb-6 sm:mb-8">
                    <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-xs mr-2">3</span>
                        Data Sosial Ekonomi
                    </h3>
                    <div class="space-y-4 sm:space-y-6">
                        {{-- Info Lembaga (Read-only) --}}
                        @if (auth()->user()->lembaga)
                            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-blue-900 mb-1">Lembaga Terdaftar</p>
                                        <p class="text-sm font-semibold text-blue-700">{{ auth()->user()->lembaga->nama }}
                                        </p>
                                        @if (auth()->user()->lembaga->alamat)
                                            <p class="text-xs text-blue-600 mt-1">{{ auth()->user()->lembaga->alamat }}
                                            </p>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <select name="kategori_mustahik_id" id="kategori_mustahik_id"
                                ...
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}"
                                        {{ old('kategori_mustahik_id') == $kategori->id ? 'selected' : '' }}>
                                        {{ $kategori->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan') }}"
                                    placeholder="Pekerjaan saat ini" maxlength="255"
                            ...
                            <div>
                                ...
                                <input type="number" name="penghasilan_perbulan" id="penghasilan_perbulan"
                                    value="{{ old('penghasilan_perbulan') }}" placeholder="0" min="0"
                                    step="1000"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="number" name="jumlah_tanggungan" id="jumlah_tanggungan"
                                    value="{{ old('jumlah_tanggungan', 0) }}" placeholder="0" min="0"
                            ...
                            <div>
                                ...
                                <select name="status_rumah" id="status_rumah"
                                    ...
                                    <option value="milik_sendiri"
                                        {{ old('status_rumah') == 'milik_sendiri' ? 'selected' : '' }}>Milik Sendiri
                                    </option>
                                    <option value="kontrak" {{ old('status_rumah') == 'kontrak' ? 'selected' : '' }}>
                                        Kontrak</option>
                                    <option value="menumpang" {{ old('status_rumah') == 'menumpang' ? 'selected' : '' }}>
                                        Menumpang</option>
                                    <option value="lainnya" {{ old('status_rumah') == 'lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                                @error('status_rumah')
                                    <p class="mt-1 text-xs sm:text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <textarea name="kondisi_kesehatan" id="kondisi_kesehatan" rows="2" placeholder="Kondisi kesehatan saat ini"
                                class="block w-full px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('kondisi_kesehatan') border-red-500 @enderror">{{ old('kondisi_kesehatan') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="catatan" id="catatan" rows="2" placeholder="Catatan tambahan"
                                class="block w-full px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('catatan') border-red-500 @enderror">{{ old('catatan') }}</textarea>
                            @error('catatan')
                                <p class="mt-1 text-xs sm:text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mb-6 sm:mb-8">
                    <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white text-xs mr-2">4</span>
                        Upload Dokumen
                    </h3>
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="space-y-3">
                                    <div id="ktp-preview"
                                        class="h-40 w-full rounded-lg bg-white flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="file" name="foto_ktp" id="foto_ktp"
                                            ...
                                            onchange="previewImage(this, 'ktp-preview', 'remove-ktp')">
                                        <label for="foto_ktp"
                                        ...
                                        <button type="button" id="remove-ktp"
                                            onclick="removeImage('foto_ktp', 'ktp-preview', 'remove-ktp')"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="file" name="foto_kk" id="foto_kk"
                                            accept="image/jpeg,image/png,image/jpg" class="hidden"
                                            onchange="previewImage(this, 'kk-preview', 'remove-kk')">
                                        <label for="foto_kk"
                                            class="flex-1 inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 cursor-pointer transition-colors">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                        ...
                                        <button type="button" id="remove-kk"
                                            onclick="removeImage('foto_kk', 'kk-preview', 'remove-kk')"
                                            class="hidden px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="file" name="foto_rumah" id="foto_rumah"
                                            accept="image/jpeg,image/png,image/jpg" class="hidden"
                                            onchange="previewImage(this, 'rumah-preview', 'remove-rumah')">
                                        ...
                                        <button type="button" id="remove-rumah"
                                            onclick="removeImage('foto_rumah', 'rumah-preview', 'remove-rumah')"
                                            class="hidden px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="space-y-3">
                                    <div
                                        class="min-h-[160px] p-4 bg-white rounded-lg border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
        ...
        function handleMultipleFiles(input) {
            ...
            Array.from(input.files).forEach((file, index) => {
                ...
                const fileIcon = file.type.includes('pdf') ?
                    ...
                    `<svg class="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clip-rule="evenodd"/></svg>`;
