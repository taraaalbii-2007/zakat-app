    ...
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-white from-primary/5 to-primary/10">
                ...
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Isi field yang diperlukan untuk menambahkan data mustahik</p>
            </div>
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <p id="kota-hint" class="mt-1 text-xs text-gray-500 {{ old('provinsi_kode') ? 'hidden' : '' }}">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <p id="kecamatan-hint" class="mt-1 text-xs text-gray-500 {{ old('kota_kode') ? 'hidden' : '' }}">
                            ...
                            <div>
                                ...
                                <p id="kelurahan-hint" class="mt-1 text-xs text-gray-500 {{ old('kecamatan_kode') ? 'hidden' : '' }}">
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-semibold text-blue-700">{{ auth()->user()->lembaga->nama }}</p>
                                    @if(auth()->user()->lembaga->alamat)
                                    <p class="text-xs text-blue-600 mt-1">{{ auth()->user()->lembaga->alamat }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="kategori_mustahik_id" id="kategori_mustahik_id"
                                ...
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}" {{ old('kategori_mustahik_id') == $kategori->id ? 'selected' : '' }}>
                                        {{ $kategori->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="penghasilan_perbulan" id="penghasilan_perbulan" value="{{ old('penghasilan_perbulan') }}"
                                    placeholder="0"
                                    min="0"
                                    step="1000"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="number" name="jumlah_tanggungan" id="jumlah_tanggungan" value="{{ old('jumlah_tanggungan', 0) }}"
                                    placeholder="0"
                                    min="0"
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="space-y-3">
                                    <div id="ktp-preview" class="h-40 w-full rounded-lg bg-white flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="button" id="remove-ktp" onclick="removeImage('foto_ktp', 'ktp-preview', 'remove-ktp')" class="hidden px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="space-y-3">
                                    <div id="kk-preview" class="h-40 w-full rounded-lg bg-white flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
                                        <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="button" id="remove-kk" onclick="removeImage('foto_kk', 'kk-preview', 'remove-kk')" class="hidden px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                            </svg>
                                        </button>
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="space-y-3">
                                    <div id="rumah-preview" class="h-40 w-full rounded-lg bg-white flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
                                        <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="button" id="remove-rumah" onclick="removeImage('foto_rumah', 'rumah-preview', 'remove-rumah')" class="hidden px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                            </svg>
                                        </button>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load cities if there's old value
            ...
            if (oldProvinsi) {
                ...
                setTimeout(() => {
                    if (oldKota) {
                        ...
                        fetchDistricts(oldKota);
                        setTimeout(() => {
                            if (oldKecamatan) {
                                kecamatanSelect.value = oldKecamatan;
                                fetchVillages(oldKecamatan);
                            }
                        }, 500);
                    }
                }, 500);
