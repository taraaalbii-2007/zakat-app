                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-yellow-800">
                                    <strong>Perhatian:</strong> Sebagai Amil, ketika Anda mengedit data mustahik, status akan otomatis menjadi <strong>Pending</strong> dan perlu diverifikasi ulang oleh Admin Lembaga.
                                </p>
                            </div>
                        </div>
                    </div>
