    ...
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
        ...
        <div class="px-4 sm:px-6 py-3 bg-blue-50 border-b border-blue-100">
            <p class="text-xs text-blue-700">
                Bulletin yang disimpan sebagai <strong>Draft</strong> tidak akan tampil ke publik.
                Pilih <strong>Kirim untuk Persetujuan</strong> agar direview oleh superadmin sebelum dipublikasikan.
            </p>
        </div>

        <form action="{{ route('admin-lembaga.bulletin.store') }}" method="POST"
              enctype="multipart/form-data" id="bulletinForm" class="p-4 sm:p-6">
            @csrf

            {{-- Hidden input untuk action (draft / submit) --}}
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 pt-6 border-t border-gray-200">
                    ...
                    <button type="button" id="btnDraft"
                            class="inline-flex items-center justify-center px-6 py-2.5 border border-gray-400 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium rounded-xl transition-colors">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    btnDraft.addEventListener('click',  () => doSubmit('draft'));
    btnSubmit.addEventListener('click', () => doSubmit('submit'));
