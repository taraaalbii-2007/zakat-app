                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            @endif
                                            <div class="min-w-0">
                                                <div class="text-sm font-medium text-gray-900 truncate max-w-xs">{{ $bulletin->judul }}</div>
                                                ...
                                                @else
                                                    <div class="text-xs text-gray-400 mt-0.5">{{ $bulletin->view_count ?? 0 }} views</div>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-700">{{ $bulletin->kategoriBulletin?->nama_kategori ?? '-' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $bulletin->published_at?->format('d M Y') ?? '-' }}</div>
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex items-start gap-3 flex-1 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        @if($bulletin->isRejected() && $bulletin->rejection_reason)
                                            <p class="text-xs text-red-500 mb-1">Ditolak: {{ Str::limit($bulletin->rejection_reason, 60) }}</p>
                                        @endif
            ...
            @else
                <div class="p-8 sm:p-12 text-center">
                    ...
                    @else
                        ...
                        <p class="text-sm text-gray-500 mb-6">Mulai buat bulletin untuk dikirim ke superadmin untuk disetujui.</p>
                        <a href="{{ route('admin-lembaga.bulletin.create') }}"
    ...
    <div id="delete-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="p-4 sm:p-6 border border-gray-200 w-full max-w-sm shadow-lg rounded-xl sm:rounded-2xl bg-white">
            ...
            <p class="text-xs sm:text-sm text-gray-500 mb-1 text-center">
                Apakah Anda yakin ingin menghapus "<span id="modal-bulletin-title" class="font-semibold text-gray-700"></span>"?
            </p>
