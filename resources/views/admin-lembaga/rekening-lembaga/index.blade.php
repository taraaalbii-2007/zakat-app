...
@section('title', 'Kelola Rekening Lembaga')
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <div>
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900">Daftar Rekening Lembaga</h2>
                        <p class="text-xs sm:text-sm text-gray-500 mt-1">Total: {{ $rekeningLembagas->total() }} Rekening</p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                        ...
                        <div id="search-container" class="transition-all duration-300"
                            ...
                            <form method="GET" action="{{ route('rekening-lembaga.index') }}" id="search-form"
            ...
            <div id="filter-panel"
                ...
                <form method="GET" action="{{ route('rekening-lembaga.index') }}" id="filter-form">
                    @if (request('q'))
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                        ...
                        <div class="flex items-end">
                            @if (request('is_active') || request('is_primary'))
                                <a href="{{ route('rekening-lembaga.index', request('q') ? ['q' => request('q')] : []) }}"
                ...
                <div class="hidden md:block overflow-x-auto" id="table-container">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($rekeningLembagas as $item)
                                @php
            ...
            @else
                <div class="p-8 sm:p-12 text-center">
                    ...
                    @else
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 mb-2">Belum Ada Rekening Lembaga</h3>
                        <p class="text-sm text-gray-500 mb-6">Mulai tambahkan rekening bank untuk lembaga Anda.</p>
                        @if ($permissions['canCreate'])
                            <a href="{{ route('rekening-lembaga.create') }}"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('confirm-delete-btn').addEventListener('click', function() {
                ...
                form.method = 'POST';
                form.action = `/rekening-lembaga/${currentRekeningUuid}`;
