@extends('layouts.app')
@section('title', 'Tambah Rekening Lembaga')
@section('content')
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-white from-primary/5 to-primary/10">
                <h2 class="text-base sm:text-lg font-semibold text-gray-900">Form Tambah Rekening Lembaga</h2>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Isi field yang diperlukan untuk menambahkan rekening lembaga</p>
            </div>
            <form action="{{ route('rekening-lembaga.store') }}" method="POST" class="p-4 sm:p-6">
                @csrf
