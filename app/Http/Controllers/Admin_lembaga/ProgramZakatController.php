<?php
// app/Http/Controllers/Admin_lembaga/ProgramZakatController.php
...
class ProgramZakatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = ProgramZakat::byLembaga($lembagaId)
        ...
        $tahunList = ProgramZakat::byLembaga($lembagaId)
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $kodeBase    = ProgramZakat::generateKodeProgram($user->lembaga_id);
            $counter     = 1;
