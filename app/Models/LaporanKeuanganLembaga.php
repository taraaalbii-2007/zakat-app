...
class LaporanKeuanganLembaga extends Model
{
    use HasFactory;

    protected $table = 'laporan_keuangan_lembaga';
    ...
    public function scopeForLembaga($query, $lembagaId = null)
    {
        $lembagaId = $lembagaId ?? session('lembaga_id');
